(function () {
    ...
    }, window.financeRoutes || {
        summary:             "/finance-dashboard/summary-json",
        approval:            "/finance-dashboard/waiting-approval-json",
        approvalHistory:     "/finance-dashboard/approval-history-json",
        rfcaPurchaseFr:      "/finance-dashboard/rfca-purchase-fr-json",
        calrPurchaseFr:      "/finance-dashboard/calr-purchase-fr-json",
        rfpNonPurchWaiting:  "/finance-dashboard/rfp-nonpurch-waiting-json",
        calrNonPurchWaiting: "/finance-dashboard/calr-nonpurch-waiting-json",
    });
    ...
    function loadTab(tab, resetPage = true) {
        ...
        const urlMap = {
            ...
            "rfca-purchase-fr":      urls.rfcaPurchaseFr,
            "calr-purchase-fr":      urls.calrPurchaseFr,
            "rfp-nonpurch-waiting":  urls.rfpNonPurchWaiting,
            "calr-nonpurch-waiting": urls.calrNonPurchWaiting,
        };
