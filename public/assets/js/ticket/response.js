...
function resetResponseTicketForm() {
    ...
    $('#response_ticket_category')
        .text('-');

    $('#response_ticket_subcategory')
        .text('-');

    $('#response_ticket_location')
        .text('-');

    $('#response_ticket_sublocation')
        .text('-');

    $('#response_use_schedule')
        .prop('checked', false);

    $('#response_schedule_container')
        .addClass('hidden');

    $('#response_working_start_date')
        .val('');

    $('#response_working_end_date')
        .val('');

    $('#btnSubmitResponseTicket')
        .prop('disabled', false);
}
...
window.openResponseTicketModal =
    openResponseTicketModal;
