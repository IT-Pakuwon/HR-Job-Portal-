(function () {
    ...
    var SAMPLE = {
        series: [
            { name: 'Revenue',  data: [44, 55, 41, 67, 72, 89, 76, 92, 80, 110, 130, 118] },
            { name: 'Expenses', data: [30, 40, 28, 52, 58, 70, 60, 75, 65, 88, 100, 95]  },
        ],
    ...
    function init(el) {
        ...
        var chart = new ApexCharts(el, {
            series: series,
            chart: {
                type: 'area', height: height, stacked: stacked,
    ...
    function boot() { document.querySelectorAll('[data-chart-type="area"]').forEach(init); }
