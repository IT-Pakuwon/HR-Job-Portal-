(function () {
    ...
    var SAMPLE = {
        series: [
            { name: 'Q1', data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
            { name: 'Q2', data: [76, 85, 101, 98, 87, 105, 91, 114, 94] },
        ],
    ...
    function boot() { document.querySelectorAll('[data-chart-type="column"]').forEach(init); }
