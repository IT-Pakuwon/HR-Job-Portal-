...
function initTicketComment() {
    ...
    attachMentionAutocomplete({
        ...
        fetchUrlFn: function () {
            ...
            return eid ? window.ticketRoutes.mentionableUsers.replace(':eid', eid) : null;
        },
    });
...
function submitTicketComment() {
    ...
    $.ajax({
        ...
        url:
            window.ticketRoutes.comment.replace(':eid', eid),
...
function reloadTicketComments(eid) {
    ...
    $.ajax({
        ...
        url:
            window.ticketRoutes.detail.replace(':eid', eid),
