...
class TrPO extends Model
{
    ...
    protected $fillable = [
        ...
        'user_peminta' , 'keperluan' , 'ponote' , 'vendorid' , 'vendorname' , 'vendoralamat' , 'vendortelp' , 
        'vendorcp' , 'vendortop' , 'totalamt' , 'taxcodeid' , 'taxamt' , 'grandtotalamt' , 'totalqty' , 
        'totalqtyreceived' , 'submitdate' , 'podeliverydate' , 'spkstartworkingdate' , 'spkendtworkingdate' , 
        'spktotalday' , 'spkworkschedule' , 'spkmanpower' , 'spkpic' , 'spkwarranty' , 'spkcarabayar' , 
        'send_email' , 'send_email_at' , 'reuse' , 'reused_at' , 'status' , 'created_by' , 'created_at' , 
