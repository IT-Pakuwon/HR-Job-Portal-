...
class BudgetDetail extends Model
{
    ...
    public function coa()
    {
        return $this->belongsTo(
            MsCoa::class,
            'account_id',   // FK di ms_budget
            'account_id'    // PK di ms_coa
        )->whereColumn('ms_coa.cpny_id', 'ms_budget.cpny_id');
    }
    ...
    public function activity()
    {
        return $this->belongsTo(
            MsActivity::class,
            'activity_id',  // FK di ms_budget
            'activity_id'   // PK di ms_activity
        )->whereColumn('ms_activity.cpny_id', 'ms_budget.cpny_id');
    }
