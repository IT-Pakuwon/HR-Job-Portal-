...
class TrReceiptdetail extends Model
{
    ...
    protected $fillable = [
        ...
        // 'updated_by',
        // 'deleted_by',
        'receiptnbr' , 'receipt_no' , 'ponbr' , 'po_no' , 'csid' , 'cs_no' , 'sppbjktid' , 'sppbjktid_no' , 'inventory_type' , 
        'inventory_sub_type' , 'inventory_category' , 'inventoryid' , 'inventory_descr' , 'qtyordered' , 'uom' , 'siteid' , 
        'type_multiplier' , 'base_multiplier' , 'base_qty' , 'base_uom' , 'unitcost' , 'taxcodeid' , 'taxamt' , 'totalcost' , 
        'receipttype' , 'qty_open_ordered' , 'base_qty_open_ordered' , 'qty_received' , 'base_qty_received' , 'qty_return' , 
        'base_qty_return' , 'ref_receiptnbr' , 'budget_perpost' , 'budget_cpny_id' , 'budget_business_unit_id' , 
        'budget_department_fin_id' , 'budget_account_id' , 'budget_activity_id' , 'budget_activity_descr' , 'status' , 'created_by' , 
