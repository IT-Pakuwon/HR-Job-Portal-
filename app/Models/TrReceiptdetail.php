...
class TrReceiptdetail extends Model
{
    ...
    protected $fillable = [
        ...
        'receiptnote_detail' , 'qtyordered' , 'uom' , 'siteid' , 'type_multiplier' , 'base_multiplier' , 'base_qty' , 
        'base_uom' , 'unitcost' , 'taxcodeid' , 'taxamt' , 'totalcost' , 'receipttype' , 'qty_received' , 'base_qty_received' , 
        'qty_return' , 'base_qty_return' , 'ref_receiptnbr' , 'budget_perpost' , 'budget_cpny_id' , 'budget_business_unit_id' , 
