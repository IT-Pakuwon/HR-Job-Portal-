...
class TrSPPT extends Model
{
    ...
    protected $fillable = [
        ...
        'pic_pengawas' , 'condition_unit' , 'beban' , 'keperluan' , 'budget_perpost' , 'woid' , 'bqid' , 'totalqty' , 
        'totalopenordered' , 'totalordered' , 'totalrejectordered' , 'totalcompleteordered' , 'assignby' , 'assigndate' ,
         'assignpurchasing' , 'csjobs' , 'cs' , 'status' , 'created_by' , 'created_at' , 'updated_by' , 'updated_at' , 
