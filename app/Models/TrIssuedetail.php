...
class TrIssuedetail extends Model
{
    ...
    protected $fillable = [
        ...
        'type_multiplier' , 'base_multiplier' , 'base_qty' , 'base_uom' , 'unitcost' , 'totalcost' , 'note' , 'location_id' , 
        'sub_location_id' , 'budget_perpost' , 'budget_cpny_id' , 'budget_business_unit_id' , 'budget_department_fin_id' , 
        'budget_account_id' , 'budget_activity_id' , 'reason_code' , 'issue_qty' , 'status' , 'created_by' , 'created_at' , 
