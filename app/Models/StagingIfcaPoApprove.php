...
class StagingIfcaPoApprove  extends Model
{
    ...
    protected $fillable = [
        ...
        'credit_terms' , 'currency_cd' , 'currency_rate' , 'total_record' , 'order_line' , 'item_cd' , 'item_type' , 
        'item_remark' , 'uom' , 'taxid', 'order_qty' , 'item_cost' , 'schedule_dt' , 'acct_type' , 'location_cd' , 
