...
class TrCS extends Model
{
    ...
    protected $fillable = [       
        ...
        'grandtotalselectedvendor2' , 'vendorid3' , 'vendorname3' , 'vendoralamat3' , 'vendortelp3' , 'vendorcp3' , 
        'vendortop3' , 'vendornote3' , 'totalvendor3' , 'taxcodevendor3' , 'ppnvendor3' , 'pphvendor3' , 'taxvendor3' , 
        'grandtotalvendor3' , 'totalselectedvendor3' , 'taxselectedvendor3' , 'grandtotalselectedvendor3' , 'vendorid4' , 
        'vendorname4' , 'vendoralamat4' , 'vendortelp4' , 'vendorcp4' , 'vendortop4' , 'vendornote4' , 'totalvendor4' , 
        'taxcodevendor4' , 'ppnvendor4' , 'pphvendor4' , 'taxvendor4' , 'grandtotalvendor4' , 'totalselectedvendor4' , 
        'taxselectedvendor4' , 'grandtotalselectedvendor4' , 'vendorid5' , 'vendorname5' , 'vendoralamat5' , 'vendortelp5' , 
        'vendorcp5' , 'vendortop5' , 'vendornote5' , 'totalvendor5' , 'taxcodevendor5' , 'ppnvendor5' , 'pphvendor5' , 
        'taxvendor5' , 'grandtotalvendor5' , 'totalselectedvendor5' , 'taxselectedvendor5' , 'grandtotalselectedvendor5' , 
        'vendorid6' , 'vendorname6' , 'vendoralamat6' , 'vendortelp6' , 'vendorcp6' , 'vendortop6' , 'vendornote6' , 
        'totalvendor6' , 'taxcodevendor6' , 'ppnvendor6' , 'pphvendor6' , 'taxvendor6' , 'grandtotalvendor6' , 
        'totalselectedvendor6' , 'taxselectedvendor6' , 'grandtotalselectedvendor6' , 'assigndate' , 'submitdate' , 
