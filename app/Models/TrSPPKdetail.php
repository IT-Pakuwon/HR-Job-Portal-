...
class TrSPPKdetail extends Model
{
    protected $connection = 'pgsql';
    protected $table = "tr_sppk_detail";

    protected $fillable = [

        'sppkid' , 'sppk_no' , 'inventory_type' , 'inventory_sub_type', 'inventory_category' , 'inventoryid' , 'inventory_descr' ,
        'qty' , 'uom' , 'siteid' , 'type_multiplier' , 'base_multiplier' , 'base_qty' , 'base_uom' , 'note' ,
        ...
        'assignby' , 'assigndate' , 'assignpurchasing' , 'openordered' , 'ordered' , 'rejectordered' , 'completeordered' ,
