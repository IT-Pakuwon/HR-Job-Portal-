...
class ReceiptListController extends Controller
{
    ...
    public function json(Request $req)
    {
        ...
        $ponbr = trim((string) $req->query('ponbr', ''));
        ...
        if ($scope === 'receiptjobs') {
            ...
            if ($deliveryDate) {
                $base->whereDate('podeliverydate', $deliveryDate);
            }
        } else {
            ...
            if ($deliveryDate) {
                $base->whereDate('receiptdate', $deliveryDate);
            }
