    ...
    if ($needStock && $businessUnitId !== '') {
        ...
        if ($bu) {
            ...
            if ($integrationType === 'SOLOMON') {
                ...
                switch (strtoupper($bu->cpny_id)) {
                    case 'AW':  $model = \App\Models\ViewInventoryAWIfca::class; break;
                    case 'EP':  $model = \App\Models\ViewInventoryEPHIfca::class; break;
                    case 'GPS': $model = \App\Models\ViewInventoryGPSIfca::class; break;
                    case 'O8':  $model = \App\Models\ViewInventoryO8Ifca::class; break;
                    case 'PSA': $model = \App\Models\ViewInventoryPSAIfca::class; break;
                }
            }
