...
class CareerController extends Controller
{
    ...
    {        
        ...
        $payrolls = Payrollconfirm::where('applicant_id', $career->applicant_id)->get();
        ...
        return view('pages.careers.showcareers', compact(
            ...
            'assessmentGroups','tr_assessment','tr_assessment_user','assessmentGroupsUser','agenda','userlist','typestep','payrolls'
        ));
    }
    ...
    public function sendemail_applicant($career, $user)
    {
        ...
        $data = [
            ...
            'url' => url('https://career.pakuwon.com') // gunakan URL lengkap
        ];
