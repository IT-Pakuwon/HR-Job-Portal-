...
class IFCAAPIPOController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        // Pastikan view kamu punya minimal: cpny_id, order_no, order_date, supplier_cd
        // Kalau punya entity_cd/order_type juga boleh ikut.
        // $srcRows = DB::table('v_staging_po')
        //     ->select([
        //         'cpny_id',
        //         DB::raw("order_no::varchar as order_no"),
