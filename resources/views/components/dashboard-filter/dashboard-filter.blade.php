...
<div class="flex items-center gap-2 overflow-x-auto pb-0.5 sm:flex-wrap sm:overflow-visible sm:pb-0">
    ...
    <div class="flex min-w-max items-center divide-x divide-slate-200 rounded-2xl border border-slate-200 bg-white shadow-sm dark:divide-slate-700/60 dark:border-slate-700/60 dark:bg-slate-900">
        ...
        <button id="gmRefreshBtn" type="button"
            class="flex items-center gap-1.5 rounded-r-2xl px-3 py-2 text-xs font-semibold text-slate-600 transition hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800/50">
    ...
    <div class="flex items-center gap-1.5 rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-700/60 dark:bg-slate-900">
