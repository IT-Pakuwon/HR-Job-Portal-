...
<div class="relative inline-flex" x-data="{ open: false }">
    <button class="group inline-flex items-center justify-center" aria-haspopup="true" @click.prevent="open = !open"
        :aria-expanded="open">
        <img class="h-8 w-8 rounded-full" src="{{ Auth::user()->profile_photo_url }}" width="32" height="32"
            alt="{{ Auth::user()->name }}" />
