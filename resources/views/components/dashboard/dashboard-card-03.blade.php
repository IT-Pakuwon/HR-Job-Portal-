<div class="shadow-xs col-span-full flex flex-col rounded-xl bg-white sm:col-span-6 xl:col-span-4 dark:bg-gray-800">
    <div class="px-5 pt-5">
        <header class="mb-2 flex items-start justify-between">
            <h2 class="text-sm font-semibold text-gray-800 dark:text-gray-100">Acme Professional</h2>
            <!-- Menu button -->
        ...
        <div class="flex items-start">
            ...
            <div class="rounded-full bg-green-500/20 px-1.5 text-xs font-medium text-green-700">+29%</div>
        </div>
    </div>
