<div class="shadow-xs col-span-full flex flex-col rounded-xl bg-white sm:col-span-6 dark:bg-gray-800">
    <header class="flex items-center border-b border-gray-100 px-5 py-4 dark:border-gray-700/60">
        ...
        <div class="relative ml-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            ...
            <div class="absolute bottom-full left-1/2 z-10 -translate-x-1/2">
                <div class="mb-2 overflow-hidden rounded-lg border border-gray-200 bg-white px-3 py-2 dark:border-gray-700/60 dark:bg-gray-800 dark:text-gray-100"
                    x-show="open" x-transition:enter="transition ease-out duration-200 transform"
                    x-transition:enter-start="opacity-0 translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-out duration-200" x-transition:leave-start="opacity-100"
                    x-transition:leave-end="opacity-0" x-cloak>
                    <div class="whitespace-nowrap text-center text-xs">Built with <a class="underline"
