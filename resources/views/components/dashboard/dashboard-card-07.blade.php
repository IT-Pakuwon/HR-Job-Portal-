<div class="shadow-xs col-span-full rounded-xl bg-white xl:col-span-8 dark:bg-gray-800">
    ...
    <div class="p-3">
        ...
        <div class="overflow-x-auto">
            <table class="w-full table-auto dark:text-gray-300">
                <!-- Table header -->
                <thead
                    class="rounded-xs bg-gray-50 text-xs uppercase text-gray-400 dark:bg-gray-700/50 dark:text-gray-500">
                    <tr>
                        <th class="p-2">
                ...
                <!-- Table body -->
                <tbody class="divide-y divide-gray-100 text-xs font-medium dark:divide-gray-700/60">
                    <!-- Row -->
                    <tr>
                        <td class="p-2">
