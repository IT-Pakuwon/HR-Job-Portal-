<div class="shadow-xs col-span-full rounded-xl bg-white xl:col-span-6 dark:bg-gray-800">
    ...
    <div class="p-3">
        ...
        <div>
            <header
                class="rounded-xs bg-gray-50 p-2 text-xs font-semibold uppercase text-gray-400 dark:bg-gray-700/50 dark:text-gray-500">
                Today</header>
            <ul class="my-1">
                <!-- Item -->
                <li class="flex px-2">
                    ...
                    <div class="flex grow items-center border-b border-gray-100 py-2 text-xs dark:border-gray-700/60">
                        <div class="flex grow justify-between">
                            ...
                            <div class="ml-2 shrink-0 self-start">
                ...
                <!-- Item -->
                <li class="flex px-2">
                    <div class="my-2 mr-3 h-9 w-9 shrink-0 rounded-full bg-gray-200">
                        <svg class="h-9 w-9 fill-current text-gray-400" viewBox="0 0 36 36">
                            <path
                    ...
                    <div class="flex grow items-center border-b border-gray-100 py-2 text-xs dark:border-gray-700/60">
                        <div class="flex grow justify-between">
                            ...
                            <div class="ml-2 shrink-0 self-start">
                                <span class="font-medium text-gray-800 line-through dark:text-gray-100">+$99.99</span>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="flex px-2">
                    ...
                    <div class="flex grow items-center py-2 text-xs">
                        <div class="flex grow justify-between">
                            <div class="self-center"><a
                                    class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white"
                                    href="#0">App.com</a> Market Ltd 70 Wilson St London</div>
