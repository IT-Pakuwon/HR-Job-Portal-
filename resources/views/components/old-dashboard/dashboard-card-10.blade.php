                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-gray-800 dark:text-gray-200">Philip Harbach</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-gray-800 dark:text-gray-200">Mirko Fisuk</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                    ...
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="font-medium text-gray-800 dark:text-gray-200">Burak Long</div>
                            </div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
