<header
    class="{{ $variant === 'v2' || $variant === 'v3' ? 'before:bg-gray-100/50 after:absolute after:h-px after:inset-x-0 after:top-full after:bg-gray-200 dark:after:bg-gray-700/60 after:-z-10' : 'max-lg:shadow-xs lg:before:bg-gray-100/50 dark:lg:before:bg-gray-900/90' }} {{ $variant === 'v2' ? 'dark:before:bg-gray-800' : '' }} {{ $variant === 'v3' ? 'dark:before:bg-gray-900' : '' }} sticky top-0 z-30 before:absolute before:inset-0 before:-z-10 before:   max-lg:before:bg-white/90 dark:max-lg:before:bg-gray-800/90">
