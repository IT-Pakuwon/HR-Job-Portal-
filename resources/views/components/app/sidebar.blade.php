                            ...
                            <ul class="@if (!in_array(Request::segment(1), ['personnels', 'personnel-requisition', 'job-posting', 'applicant-portal'])) {{ 'hidden' }} @endif mt-1 pl-8"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="@if (Route::is('jobapplicant')) {{ 'text-violet-500!' }} @endif block truncate text-gray-500/90 transition hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                                        ...
                                        <span
                                            class="lg:sidebar-expanded:opacity-100 text-m font-medium duration-200 lg:opacity-0 2xl:opacity-100">Job
                                            & Applicant</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="@if (Route::is('careers')) {{ 'text-violet-500!' }} @endif block truncate text-gray-500/90 transition hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                                        href="{{ route('careers') }}">
                                        <span
