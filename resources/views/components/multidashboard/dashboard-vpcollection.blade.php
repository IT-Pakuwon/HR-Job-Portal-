    ...
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400">
                Approval • Expired Voucher • Settlement
            </p>
        </div>
...
<script>
    window.vplDashboardConfig = {
        typeLabel: 'Voucher',
        expiredTabLabel: 'Expired Voucher List',
        settlementTabLabel: 'Waiting For Settlement',
        routes: {
            summary: "{{ route('vpcoll-dashboard.summary-json') }}",
            approval: "{{ route('vpcoll-dashboard.waiting-approval-json') }}",
            approvalHistory: "{{ route('vpcoll-dashboard.approval-history-json') }}",
            expired: "{{ route('vpcoll-dashboard.expired-json') }}",
            waitingSettlement: "{{ route('vpcoll-dashboard.waiting-settlement-json') }}",
            doctypes: "{{ route('vpcoll-dashboard.approval-doctypes-json') }}",
        },
    };
</script>
