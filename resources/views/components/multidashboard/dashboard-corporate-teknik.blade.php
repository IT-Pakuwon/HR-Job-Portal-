<div class="space-y-4">
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400">
                Waiting Approval • Approval History • Ticket • Berita Acara
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <div
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="openTicketBar" class="h-full rounded-full bg-blue-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="openBeritaAcaraCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="openBeritaAcaraBar" class="h-full rounded-full bg-violet-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
...
<style>
    ...
    #statusFilterWrap .select2-selection--single {
        height: 34px;
        display: flex;
        align-items: center;
    ...
    #statusFilterWrap .select2-selection--single:hover {
        border-color: #94a3b8;
    }
    #dashboardFilterWrap .select2-container--open .select2-selection--single,
    #statusFilterWrap .select2-container--open .select2-selection--single {
        border-color: #6366f1;
        box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.15);
    }
    #dashboardFilterWrap .select2-selection__rendered,
    #statusFilterWrap .select2-selection__rendered {
        padding: 0;
        line-height: 32px;
        color: #334155;
    }
    #dashboardFilterWrap .select2-selection__arrow,
    #statusFilterWrap .select2-selection__arrow {
        height: 32px;
        right: 8px;
    }
    #dashboardFilterWrap .select2-selection__arrow b,
    #statusFilterWrap .select2-selection__arrow b {
        border-color: #94a3b8 transparent transparent transparent;
    }

    #dashboardFilterWrap .select2-dropdown,
    #statusFilterWrap .select2-dropdown {
        border-radius: 0.5rem;
        border-color: #c7d2e1;
        overflow: hidden;
    ...
    #statusFilterWrap .select2-search__field {
    ...
    #statusFilterWrap .select2-search__field:focus {
        border-color: #6366f1;
    }
    #dashboardFilterWrap .select2-results__option,
    #statusFilterWrap .select2-results__option {
        font-size: 0.75rem;
        padding: 0.5rem 0.75rem;
    }
    #dashboardFilterWrap .select2-results__option--highlighted[aria-selected],
    #statusFilterWrap .select2-results__option--highlighted[aria-selected] {
        background-color: #eef2ff;
        color: #4338ca;
    }
    #dashboardFilterWrap .select2-results__option[aria-selected="true"],
    #statusFilterWrap .select2-results__option[aria-selected="true"] {
    ...
    .dark #statusFilterWrap .select2-selection--single {
        background-color: #334155;
        border-color: #475569;
        color: #e2e8f0;
    }
    .dark #dashboardFilterWrap .select2-selection__rendered,
    .dark #statusFilterWrap .select2-selection__rendered {
        color: #e2e8f0;
    }
    .dark #dashboardFilterWrap .select2-selection__arrow b,
    .dark #statusFilterWrap .select2-selection__arrow b {
        border-color: #94a3b8 transparent transparent transparent;
    }
    .dark #dashboardFilterWrap .select2-dropdown,
    .dark #statusFilterWrap .select2-dropdown {
        background-color: #1e293b;
        border-color: #475569;
    }
    .dark #dashboardFilterWrap .select2-search__field,
    .dark #statusFilterWrap .select2-search__field {
        background-color: #334155;
        border-color: #475569;
        color: #e2e8f0;
    }
    .dark #dashboardFilterWrap .select2-results__option,
    .dark #statusFilterWrap .select2-results__option {
        color: #e2e8f0;
    }
    .dark #dashboardFilterWrap .select2-results__option--highlighted[aria-selected],
    .dark #statusFilterWrap .select2-results__option--highlighted[aria-selected] {
        background-color: #4338ca;
        color: #fff;
    }
    .dark #dashboardFilterWrap .select2-results__option[aria-selected="true"],
    .dark #statusFilterWrap .select2-results__option[aria-selected="true"] {
