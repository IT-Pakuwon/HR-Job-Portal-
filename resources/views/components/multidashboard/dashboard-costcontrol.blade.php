        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="approvalCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="approvalBar" class="h-full rounded-full bg-emerald-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="poCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="poBar" class="h-full rounded-full bg-orange-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="issueCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
                <div class="rounded-lg bg-rose-500/10 p-2 text-base">
                    🚚
                </div>
            </div>
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="issueBar" class="h-full rounded-full bg-rose-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="budgetCount" class="mt-0.5 truncate text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="min-w-0">
                    ...
                    <div id="imBudgetCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="imBudgetBar" class="h-full rounded-full bg-violet-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
