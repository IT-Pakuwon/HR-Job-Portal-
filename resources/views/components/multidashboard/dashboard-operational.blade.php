<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="min-w-0">
                    ...
                    <div id="waitingApprovalCount"
                        class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
                </div>
        ...
        <div
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="workOrderBar" class="h-full rounded-full bg-orange-500 transition-all duration-500" style="width:0%"></div>
            </div>
...
<script src="{{ asset('assets/js/multidashboard/dashoperational.js') }}?v={{ file_exists(public_path('assets/js/multidashboard/dashoperational.js')) ? filemtime(public_path('assets/js/multidashboard/dashoperational.js')) : time() }}"></script>
