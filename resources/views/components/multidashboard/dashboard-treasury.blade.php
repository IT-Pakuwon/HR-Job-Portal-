<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <div class="rounded-lg border border-slate-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="rfcaPurchaseTpBar" class="h-full rounded-full bg-amber-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-slate-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="calrPurchaseTpBar" class="h-full rounded-full bg-emerald-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-slate-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="rfpNonPurchFrDoneBar" class="h-full rounded-full bg-violet-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-slate-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="calrNonPurchFrDoneBar" class="h-full rounded-full bg-rose-500 transition-all duration-500" style="width:0%"></div>
            </div>
        </div>
    ...
    <div class="rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        <div class="border-b border-slate-200 px-4 py-3 dark:border-slate-700">
            <div class="flex flex-wrap gap-3">
                ...
                <button id="tab-rfca-purchase-tp">💳 RFCA Purchase Waiting</button>
                <button id="tab-calr-purchase-tp">🔁 CALR Purchase Waiting</button>
                <button id="tab-rfp-nonpurch-fr-done">📄 RFP & RFCA Non-Purchase Waiting</button>
                <button id="tab-calr-nonpurch-fr-done">📑 CALR Non-Purchase Waiting</button>
            </div>
        </div>
...
<script src="{{ asset('assets/js/multidashboard/dashtreasury.js') }}?v={{ file_exists(public_path('assets/js/multidashboard/dashtreasury.js')) ? filemtime(public_path('assets/js/multidashboard/dashtreasury.js')) : time() }}"></script>
