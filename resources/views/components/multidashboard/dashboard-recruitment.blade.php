    ...
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400">
                Approval • Applicants • Self Register
            </p>
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('recruitment.dashboard') }}"
                class="flex items-center justify-center gap-1.5 rounded-lg bg-black px-3 py-2 text-xs font-semibold text-white hover:bg-gray-900 dark:bg-zinc-700 dark:hover:bg-zinc-600">
                <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="min-w-0">
                    ...
                    <div id="approvalHistoryCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>

                </div>

                <div class="rounded-lg bg-slate-500/10 p-2 text-base">
                    📋
                </div>

            </div>
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="approvalHistoryBar" class="h-full rounded-full bg-slate-500 transition-all duration-500" style="width:0%"></div>
            </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="min-w-0">
                    ...
                    <div class="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400">
                        Total New (Unchecked) Applicant
                    </div>

                    <div id="applicantCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>
            ...
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="applicantBar" class="h-full rounded-full bg-violet-500 transition-all duration-500" style="width:0%"></div>
            </div>
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="min-w-0">
                    ...
                    <div class="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400">
                        Total New Self Applicant
                    </div>

                    <div id="selfRegisterCount" class="mt-0.5 text-xl font-bold text-slate-900 dark:text-white">
                        0
                    </div>

                </div>

                <div class="rounded-lg bg-cyan-500/10 p-2 text-base">
                    👥
                </div>

            </div>
            <div class="mt-2 h-1 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
                <div id="selfRegisterBar" class="h-full rounded-full bg-cyan-500 transition-all duration-500" style="width:0%"></div>
            </div>
