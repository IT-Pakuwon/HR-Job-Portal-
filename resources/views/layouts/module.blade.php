...
<x-app-layout>
    ...
    <div
        ...
        <div class="flex h-full flex-col rounded-xl border bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <template x-if="!googleConnected">
                            <a href="/auth/google/calendar" class="rounded-lg border border-gray-300 px-3 py-2 text-xs">
                                Connect Google Calendar
                            </a>
                        </template>

                        <template x-if="googleConnected">
                            <span class="rounded-lg bg-green-100 px-3 py-2 text-xs text-green-700">
                                ✓ Google Connected
                            </span>
                        </template>

                        <button @click="showModal = true" class="rounded-lg bg-indigo-600 px-4 py-2 text-xs text-white">
                            Create Task
                        </button>
                    </div>
                </div>
                        ...
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-gray-700">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <!-- META -->
                                    <div class="mt-1 space-y-1 text-xs text-gray-500 dark:text-gray-300">
