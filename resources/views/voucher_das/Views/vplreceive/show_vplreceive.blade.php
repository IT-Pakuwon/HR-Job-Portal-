...
<div class="content-wrapper" style="background-color: #051931;">
    ...
    <section class="content-header">    
        <h1 style="color:white">
            Show Receive
            <small>-</small> 
                <a href="{{ url('/printvplreceive') }}_{{ $vplreceive->id }}" button type="button" class="btn mb-1 btn-warning " target="_blank">Print Receive</a>           
        ...
        <ol class="breadcrumb">
            ...
            <li class="active" style="color: white;font-size:13px">Show Receive</li>
        </ol>       
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-7">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Receive Information</h3>

                        <div class="box-tools pull-right">
                            <a href="{{ url('/editvplreceive') }}_{{ $vplreceive->id }}" button type="button" hide class="btn mb-1 btn-danger " style="<?php echo $hidden; ?>">Edit</a>
                    ...
                    <div class="box-body no-padding" style="height: 280px; overflow-y: auto;">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->receive_id }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Date</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->receive_date }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->cpnyid }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Department</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->department }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->user }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Voucher / Product Type </label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->vp_type == 'V' ? 'VOUCHER' : ($vplreceive->vp_type == 'P' ? 'PRODUCT' : '') }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Receive Type</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->receive_type }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Tenant</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->receive_tenant }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">       
                                ...
                                <label for="inputEmail3" class="col-sm-2 control-label">Department of Receive</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplreceive->source_receive_dept }}" readonly>
                                </div>                                
                            </div>                            
                        </div>   
                        <div class="box-body">
                            <div class="form-group">                               
                                ...
                                <div class="col-sm-10">  
                                    <textarea class="form-control" rows="2" id="receive_remark" name="receive_remark" readonly>{{ $vplreceive->receive_remark }}</textarea>
                                </div>                                
                            </div>                            
                        </div>          
                    </div>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Receive Detail</h3>
                    ...
                    <div class="box-footer">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="btnsend" type="submit" class="btn btn-warning btn-flat" onclick="send({{ $vplreceive->id }})">Send</button>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form class="form-horizontal" action="{{ url('/approvevplreceive') }}_{{ $vplreceive->id }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}                                    
                ...
                <div class="modal modal-danger fade" id="modal-danger">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/rejectvplreceive') }}_{{ $vplreceive->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-success fade" id="modal-success">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/revisevplreceive') }}_{{ $vplreceive->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-danger fade" id="modal-cancel">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/vplreceivecancel') }}_{{ $vplreceive->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}                               
                                <div class="modal-body">
...
<script>
    function send(id) {      
       ...
       $.ajax({
          url: "{{ url('/sendmsgvplreceive') }}_" + id, 
          type: "get",  
          data: "msg=" + msg,              
