                ...
                <div class="box-body">
                    <div class="box-body">
                        <div class="col-md-12">                            
                            ...
                            <div class="col-sm-3">
                                <select class="form-control select2" name="receive_tenant" style="width: 100%;" required>                                    
                                    @foreach($msproduct as $p)                                   
                                    <option value="{{ $p->product_source_tenant }}" {{ $p->product_source_tenant == $vplreceive->receive_tenant ? 'selected' : '' }}>{{ $p->product_source_tenant }}</option>
                                    @endforeach
                                </select>                               
                            </div>       
                        ...
                        <div class="col-md-12">    
                            ...
                            <div class="col-sm-2">
                                <select class="form-control select2" id="receive_type" name="receive_type" style="width: 100%;">
                                    ...
                                    <option value="Media Promosi" {{ $vplreceive->receive_type == 'Media Promosi' ? 'selected' : '' }}>Media Promosi</option>
                                    <option value="Other" {{ $vplreceive->receive_type == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        isValid &= validateSelectField('receive_tenant', 'Tenant is required');
