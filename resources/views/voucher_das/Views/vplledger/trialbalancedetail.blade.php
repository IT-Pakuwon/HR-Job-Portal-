                ...
                <table class="table table-bordered data-table">
                    <thead>
                        ...
                        <tr class="sub-header">                               
                            ...
                            <th>Out<br>Promotion</th>                               
                            <th>Out<br>Dijual</th>
                            <th>Out<br>Write Off</th>
...
<script type="text/javascript">
    $(function () {      
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('trialbalancedetail.trialbalancedetail') }}",
                data: function (d) {
                    d.cpnyid = $('#cpnyid').val();
            ...
            columns: [        
                ...
                {data: 'qtyout_promotion', name: 'qtyout_promotion'}, 
                {data: 'qtyout_dijual', name: 'qtyout_dijual'},
                {data: 'qtyout_writeoff', name: 'qtyout_writeoff'},
