...
<script>
    $(document).ready(function() {
        ...
        function loadProducts(transfertype, cpnyid, rowIndex) {
            $.ajax({
        ...
        var initialTransfertype = $('#transfertype').val();
        var initialCpnyid = $('select[name="cpnyid"]').val();
        
        // Load untuk row pertama (index 0)
        loadProducts(initialTransfertype, initialCpnyid, 0);
        loadToWhsOptions(initialCpnyid, initialTransfertype, 0);
        ...
        $('select[name="cpnyid"]').on('change', function() {
            ...
            // loadProducts(transfertype, cpnyid, 0); // Load data untuk modal awal (rowIndex 0)
        ...
        function loadToWhsOptions(cpnyid, transfertype, rowIndex) {
        ...
        $('#addRow').click(function() {
            ...
            loadProducts(transfertype, cpnyid, i);
