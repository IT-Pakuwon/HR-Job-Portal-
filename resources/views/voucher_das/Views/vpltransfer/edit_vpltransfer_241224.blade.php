                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary select-product"
                                                        ...
                                                        data-row-index="0" data-dismiss="modal">Select</button>
                                                </td>
                                            </tr>
                                            @endforeach --}}
                                        </tbody>
...
<script>
    ...
    $('#addRow').click(function() {
        ...
        $.ajax({
            url: "{{ route('getProductsByTransferType') }}", // Buat route untuk handle request ini
            type: 'GET',
...
<script>    
    $('#transfertype').on('change', function() {            
        var transfertype = $(this).val(); // Ambil nilai transfer type (Transfer atau Return)
        var i =0;
        // Ajax request untuk mengambil data produk berdasarkan transfer type
        $.ajax({
            url: "{{ route('getProductsByTransferType') }}", // Buat route untuk handle request ini
            type: 'GET',
            data: { transfertype: transfertype },
