...
<table style="height: 58px; width: 684px;">
    ...
    <tr>
        <td style="width: 674px; text-align: center;">
            <h3><strong>TRANSFER VOUCHER/PRODUCT</strong></h3>
        </td>
    </tr>   
    </tbody>
</table>
    ...
    <tbody>        
        <tr style="height: 21px;">
            ...
            <td style="width: 500.75px; height: 21px;">: {{ $transfertype }}</td>
        </tr>            
        <tr style="height: 25px;">
            <td style="width: 160.25px; height: 25px;">Remark</td>
            <td style="width: 500.75px; height: 25px;">: {{ $transfer_remark }}</td>
        </tr>
    </tbody>
</table>  
{{-- <p>&nbsp;</p> --}}
...
<table border="1" cellpadding="1" cellspacing="1" style="width:720px; border-collapse: collapse; border: 1px solid black;">
    <tbody>
        <tr style="height: 21px;">
            ...
            <td style="width: 30px; height: 21px;">Stock</td>
            <td style="width: 30px; height: 21px;">Qty</td>
            <td style="width: 100px; height: 21px;">From Gudang</td>
            <td style="width: 100px; height: 21px;">To Gudang</td>
        </tr>
        @foreach($vpltransferdetail as $dt)    
        <tr style="height: 26px;">
            ...
            <td style="width: 30px; height: 26px;">{{ $dt->qty_available }}</td>
            <td style="width: 30px; height: 26px;">{{ $dt->qty_transfer }}</td>
            <td style="width: 100px; height: 26px;">{{ $dt->from_whs_id }}</td>
            <td style="width: 100px; height: 26px;">{{ $dt->to_whs_id }}</td>
        </tr>
        @endforeach    
    </tbody>
</table>
