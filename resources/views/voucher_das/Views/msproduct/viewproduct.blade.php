        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body no-padding" style="height: 330px; overflow-y: auto;">
                        <div class="box-body">
                            <div class="form-group">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $msproduct->product_type == 'V' ? 'VOUCHER' : ($msproduct->product_type == 'P' ? 'PRODUCT' : '') }}" readonly>
                                </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ number_format($msproduct->product_value, 0, ',', '.') }}" readonly>
                                </div>                                
                            </div>                            
                        </div>              
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Product Source</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $msproduct->product_source_type }}" readonly>
                                </div>    
            ...
            <div class="col-md-5">
                ...
                <div class="box box-info" style="height: 300px; overflow-y: auto;">
                    <div class="box-header with-border">
                ...
                <div class="box box" style="height: 180px; overflow-y: auto;">
                    <div class="box-header with-border">
