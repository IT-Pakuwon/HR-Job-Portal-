...
<div class="content-wrapper" style="background-color: #051931;">
    ...
    <section class="content-header">    
        <h1 style="color:white">
            Show {{ $adjustmenttype }}
            <small>-</small> 
                <a href="{{ url('/printvpladjustment') }}_{{ $vpladjustment->id }}" button type="button" class="btn mb-1 btn-warning " target="_blank">Print {{ $adjustmenttype }}</a>           
        ...
        <ol class="breadcrumb">
            ...
            <li class="active" style="color: white;font-size:13px">Show {{ $adjustmenttype }}</li>
        </ol>       
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-7">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ $adjustmenttype }} Information</h3>

                        <div class="box-tools pull-right">
                            <a href="{{ url('/editvpladjustment') }}_{{ $vpladjustment->id }}" button type="button" hide class="btn mb-1 btn-danger " style="<?php echo $hidden; ?>">Edit</a>
                    ...
                    <div class="box-body no-padding" style="height: 280px; overflow-y: auto;">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">{{ $adjustmenttype }} No</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vpladjustment->adjustment_id }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Date</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vpladjustment->adjustment_date }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vpladjustment->cpnyid }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Department</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vpladjustment->department }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $adjustmenttype }}" readonly>
                                </div>                                                          
                            </div>                            
                        </div> 
                        ...
                        <div class="box-body">
                            <div class="form-group">                               
                                ...
                                <div class="col-sm-10">  
                                    <textarea class="form-control" rows="3" id="adjustment_remark" name="adjustment_remark" readonly>{{ $vpladjustment->adjustment_remark }}</textarea>
                                </div>                                
                            </div>                            
                        </div>          
                    </div>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ $adjustmenttype }} Detail</h3>
                    ...
                    <div class="box-footer">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="btnsend" type="submit" class="btn btn-warning btn-flat" onclick="send({{ $vpladjustment->id }})">Send</button>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form class="form-horizontal" action="{{ url('/approvevpladjustment') }}_{{ $vpladjustment->id }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}                                    
                ...
                <div class="modal modal-danger fade" id="modal-danger">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/rejectvpladjustment') }}_{{ $vpladjustment->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-success fade" id="modal-success">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/revisevpladjustment') }}_{{ $vpladjustment->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-danger fade" id="modal-cancel">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/vpladjustmentcancel') }}_{{ $vpladjustment->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}                               
                                <div class="modal-body">
...
<script>
    function send(id) {      
       ...
       $.ajax({
          url: "{{ url('/sendmsgvpladjustment') }}_" + id, 
          type: "get",  
          data: "msg=" + msg,              
