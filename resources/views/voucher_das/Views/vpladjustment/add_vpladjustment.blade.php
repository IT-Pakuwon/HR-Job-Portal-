...
<div class="content-wrapper" style="background-color: #051931; border-radius: 5px 0 0 0; margin-top:3rem; padding-left:2rem; padding-right:2rem">
    ...
    <section class="content-header">
        <h1 style="color: white">Create Adjustment</h1>
        <ol class="breadcrumb" style="background: transparent;">
            <li><a href="#" style="color: white;font-size:13px"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active" style="color: white;font-size:13px">Create Adjustment</li>
        </ol>
    </section>
                ...
                <div class="box-body">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">  
                            ...
                            <div class="col-sm-4">
                                <textarea type="text" rows="3" class="form-control" name="adjustment_remark"  placeholder="Enter Remarks ..."></textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#saveBUTTON').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('savevpladjustment') }}", // Ubah dengan route yang sesuai
                data: formData,
                contentType: false,
                processData: false,
   ...
   // Validation logic for the dynamic table
    function validateDynamicTable() {
        ...
        $('#dynamicTable tbody tr').each(function() {           
            ...
            //     qtyAdjustmentField.after('<span class="error-message" style="color: red;">Qty Adjustment is required and must be greater than 0</span>');
            //     isValid = false;
            // } else if (qtyAdjustment > qtyAvailable) {
            //     qtyAdjustmentField.after('<span class="error-message" style="color: red;">Qty Adjustment cannot be greater than available stock</span>');
            //     isValid = false;
            // }
