...
<div class="content-wrapper" style="background-color: #051931;">
    ...
    <section class="content-header">    
        <h1 style="color:white">
            Show {{ $requesttype }}
            <small>-</small> 
                <a href="{{ url('/printvplrequest') }}_{{ $vplrequest->id }}" button type="button" class="btn mb-1 btn-warning " target="_blank">Print {{ $requesttype }}</a>           
        ...
        <ol class="breadcrumb">
            ...
            <li class="active" style="color: white;font-size:13px">Show {{ $requesttype }}</li>
        </ol>       
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ $requesttype }} Information</h3>

                        <div class="box-tools pull-right">
                            <a href="{{ url('/editvplrequest') }}_{{ $vplrequest->id }}" button type="button" hide class="btn mb-1 btn-danger " style="<?php echo $hidden; ?>">Edit</a>
                    ...
                    <div class="box-body no-padding" style="height: 280px; overflow-y: auto;">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">{{ $requesttype }} No</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->request_id }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Date</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->request_date }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->cpnyid }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Department</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->department }}" readonly>
                                </div>                                
                            </div>                            
                        </div> 
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->user }}" readonly>
                                </div>
                                <label for="inputEmail3" class="col-sm-2 control-label">Voucher / Product Type</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" value="{{ $vplrequest->vp_type == 'V' ? 'VOUCHER' : ($vplrequest->vp_type == 'P' ? 'PRODUCT' : '') }}" readonly>
                                ...
                                <div class="col-sm-4">
                                    @php
                                        ...
                                        if ($vplrequest->requesttype == 'Usage') {
                                            $requestType = 'Usage';
                                        } elseif ($vplrequest->requesttype == 'Return') {
                                            $requestType = 'Return';
                                        } elseif ($vplrequest->requesttype == 'Adjusment') {
                                            $requestType = 'Adjusment';
                                        }
                                    @endphp

                                    <input type="text" class="form-control" value="{{ $requestType }}" readonly>
                                    {{-- <input type="text" class="form-control" value="{{ $vplrequest->requesttype }}" readonly> --}}
                                </div>                                                          
                            </div>                            
                        </div> 
                        @if ($vplrequest->requesttype == 'Usage')
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Ref No</label>
                                <div class="col-sm-4">                                    
                                    <a href="{{ url('/showvplrequest') }}_{{ $vplrequest_ref->id }}" button type="button" hide class="btn mb-1 btn-primary" target="_blank">{{ $vplrequest->ref_request_id }}</a>
                                </div>                                                             
                            </div>                            
                        </div> 
                        @endif
                        ...
                        <div class="box-body">
                            <div class="form-group">                               
                                ...
                                <div class="col-sm-10">  
                                    <textarea class="form-control" rows="3" id="request_remark" name="request_remark" readonly>{{ $vplrequest->request_remark }}</textarea>
                                </div>                                
                            </div>                            
                        </div>          
                    </div>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ $requesttype }} Detail</h3>
            ...
            <div class="col-md-5">
                <div class="box box-info" style="height:323px; overflow-y: auto;">
                    <div class="box-header with-border">
                ...
                <div class="box box-warning direct-chat direct-chat-warning" id="msg_load" data-messages="{{ count($t_message) }}">
                    ...
                    <div class="box-body">                      
                            <div class="direct-chat-messages" style="height: 110px; overflow-y: auto;">                          
                    ...
                    <div class="box-footer">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="btnsend" type="submit" class="btn btn-warning btn-flat" onclick="send({{ $vplrequest->id }})">Send</button>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form class="form-horizontal" action="{{ url('/approvevplrequest') }}_{{ $vplrequest->id }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}                                    
                ...
                <div class="modal modal-danger fade" id="modal-danger">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/rejectvplrequest') }}_{{ $vplrequest->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-success fade" id="modal-success">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/revisevplrequest') }}_{{ $vplrequest->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="modal-body">
                ...
                <div class="modal modal-danger fade" id="modal-cancel">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('/vplrequestcancel') }}_{{ $vplrequest->id }}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}                               
                                <div class="modal-body">
...
<script>
    function send(id) {      
       ...
       $.ajax({
          url: "{{ url('/sendmsgvplrequest') }}_" + id, 
          type: "get",  
          data: "msg=" + msg,              
