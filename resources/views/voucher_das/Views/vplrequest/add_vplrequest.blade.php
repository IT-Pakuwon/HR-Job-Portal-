...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#saveBUTTON').click(function (e) {
            ...
            sevenDaysAgo.setDate(today.getDate() - 50); // Set H-7
            ...
            if ($('#productTempTableBody tr').length === 0) {
                alert('Product / Voucher Empty, Silahkan klik button ADD!');
                return false;
            }
        ...
        async function validateProductAvailability() {
            ...
            const vp_type = $('select[name="vp_type"]').val()
...
<script>
   $(document).ready(function () {
    ...
    console.log(cpnyid,' ',department,' ', vp_type);
        ...
        $('select[name="product_id"]').on('change', function () {
            ...
            console.log('cpnyid     =', cpnyid);
            console.log('department =', department);
            console.log('vp_type    =', vp_type);
            ...
            formData.append('requesttype', selectedRequestType);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // kalau server suatu saat balikin 200 tapi berisi error
                        if (data && data.error) {
                        toastr.error(data.error); // atau: alert(data.error);
                        return;
                        }
                    ...
                    // }
                    error: function (xhr) {
                        // baca pesan dari response 400/422
                        ...
                        toastr.error(msg); // atau pakai alert(msg);
                    }
