    ...
    <div class="max-w-9xl mx-auto w-full p-2">
        <div
            ...
            <div
                ...
                <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">📅 Calendar
                    Exception List</h2>
            ...
            <div class="relative mt-4 overflow-hidden">
                <table id="calendarTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
