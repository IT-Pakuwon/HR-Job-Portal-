                        ...
                        <div class="flex w-full flex-col">
                                ...
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        ...
                                        <div class="flex gap-10">
                                            ...
                                            <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Personal
                                                Information</h2>
                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center gap-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p
                                                                        class="word-break: break-all text-base font-medium text-gray-900 dark:text-gray-100">
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Education
                                        </h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Work
                                            Experience</h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Languange
                                        </h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Certificate
                                        </h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Strengths &
                                            Weaknesses</h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                        ...
                        <div class="flex w-full flex-col">
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Marital
                                            Status & Children</h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Emergency
                                            Contact</h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
                            ...
                            <div x-data="{ isOpen: true }" class="pb-4">
                                <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                    ...
                                    <header
                                        class="flex items-center justify-between border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700">
                                        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Relative
                                            Information</h2>
                                        <button @click="isOpen = !isOpen"
                                            class="flex items-center text-gray-500 focus:outline-none dark:text-gray-200">
                                            <span x-text="isOpen ? 'Closed' : 'See Details'"></span>
