<x-app-layout>
    ...
    <div class="px-2 sm:px-6 lg:px-2 w-full py-0 max-w-9xl mx-auto">
        ...
        <div class="flex items-center justify-between  sm:mb-0">
            <!-- Title Page -->
            <div class="grid grid-rows-5 xl:grid-cols-5 xl:grid-rows-1 gap-6">
                <button>
                    <a href="#" class="status-filter" data-status="">
                        <div class="p-4 rounded-lg bg-orange-200/20 border border-orange-700 text-orange-600 flex items-center gap-4 shadow-md shadow-white">
                ...
                <button>
                    <a href="#" class="status-filter" data-status="P">
                        <div class="p-4 rounded-lg bg-blue-200/20 border border-blue-700 text-blue-600 flex items-center gap-4 shadow-md  shadow-white">
                            <span class="text-4xl">⏳</span>
                            <div>
                                <p class="text-lg font-medium">On Progress</p>
                                <p class="text-3xl text-left font-extrabold">{{ $onProgress }}</p>
                            </div>
                        </div>
                    </a>
                </button>
                <button>
                    <a href="#" class="status-filter" data-status="R">
                        <div class="p-4 rounded-lg bg-red-200/20  border border-red-700 text-red-600 flex items-center gap-4 shadow-md shadow-white">
                            <span class="text-4xl">⛔️</span>
                            <div>
                                <p class="text-lg font-medium">Reject</p>
                                <p class="text-3xl text-left font-extrabold">{{ $reject }}</p>
                            </div>
                        </div> 
                    </a>
                </button>
                <button>
                    <a href="#" class="status-filter" data-status="D">
                        <div class="p-4 rounded-lg bg-gray-200/20  border border-gray-700 text-gray-600 flex items-center gap-4 shadow-md shadow-white">
                            <span class="text-4xl">✏️</span>
                            <div>
                                <p class="text-lg font-medium">Revise</p>
                                <p class="text-3xl text-left f font-extrabold">{{ $revise }}</p>
                            </div>
                        </div>
                    </a>
                </button>
                <button>
                    <a href="#" class="status-filter" data-status="C">
                        <div class="p-4 rounded-lg bg-green-200/20  border border-green-700 text-green-600 flex items-center gap-4 shadow-md shadow-white">
                            <span class="text-4xl">✅</span>
                            <div>
                                <p class="text-lg font-medium">Completed</p>
                                <p class="text-3xl  text-left font-extrabold">{{ $completed }}</p>
                            </div>
                        </div>
                    </a>
                </button>
        ...
        <div class="grid">
            ...
            <style>
                ...
                #applicantsTable th:nth-child(1), #applicantsTable td:nth-child(1) {
                    width: 120px;
                    text-align: center;
                }
                #applicantsTable th:nth-child(4), #applicantsTable td:nth-child(4) {
                    width: 120px;
                    text-align: center;
                }
            </style>
            <div class="mt-6  overflow-y-auto bg-white  dark:bg-gray-800 p-4 rounded-xl">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg">
                    <table id="applicantsTable" class="min-w-full rounded mt-5">
                        ...
                        columns: [
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    let buttonClass = 'px-4 py-2.5 bg-indigo-500 text-white rounded hover:bg-indigo-700';
                            ...
                            { data: 'full_name',className: 'no-pointer' },
                            { data: 'age',className: 'no-pointer' },
                            { data: 'gender',className: 'no-pointer' },
                            { data: 'phone_number',className: 'no-pointer' },
                            { data: 'email_address',className: 'no-pointer'  },
                            {
                                ...
                                render: function (data) {
                                    ...
                                    if (data === 'D') {
                                        statusText = "Revise";
                                        badgeClass = "w-32 bg-gray-300/30 dark:bg-gray-300 text-gray-600 focus:outline-none pointer-events-none border-none font-semibold px-4 py-2 text-center rounded";
                                    } else if (data === 'P') {
