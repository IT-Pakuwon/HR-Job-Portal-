        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                <tr class="transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    <td
                        class="whitespace-nowrap border-r border-gray-200 px-6 py-4 text-xs font-medium text-gray-900 dark:border-gray-700 dark:text-gray-100">
                        SUITABLE</td>
                ...
                <tr class="transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    <td
                        class="whitespace-nowrap border-r border-gray-200 px-6 py-4 text-xs font-medium text-gray-900 dark:border-gray-700 dark:text-gray-100">
                        CONSIDER</td>
                    <td class="px-6 py-4 text-xs text-gray-700 dark:text-gray-300">15–19</td>
                </tr>
                <tr class="transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    <td
                        class="whitespace-nowrap border-r border-gray-200 px-6 py-4 text-xs font-medium text-gray-900 dark:border-gray-700 dark:text-gray-100">
                        NOT SUITABLE</td>
                    <td class="px-6 py-4 text-xs text-gray-700 dark:text-gray-300">0–14</td>
                </tr>
            </tbody>
        </table>
    </div>
