                ...
                <div class="flex w-full flex-col">
                    <div x-data="tabsComponent()" x-init="initializeComponent()">
                        <div
                            ...
                            :class="tab === 'tab1' ? 'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200'"
                            ...
                            :class="tab === 'tab2' ? 'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200'"
                            class="whitespace-nowrap px-3 py-3 text-lg font-medium transition-colors duration-200 focus:outline-none sm:px-4 sm:text-base">
                            Applicant Profile
                            </button>
                            <button @click="tab = 'tab3'; content3Loaded = true"
                            :class="tab === 'tab3' ? 'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200'"
                            class="whitespace-nowrap px-3 py-3 text-lg font-medium transition-colors duration-200 focus:outline-none sm:px-4 sm:text-base">
                            Job Information
                            </button>
                        </div>
                        ...
                        <div>
                            <div x-show="tab === 'tab1'"
                                ...
                                x-data="{ isOpen: false }"> <!-- supaya partial yang pakai isOpen tidak error -->
