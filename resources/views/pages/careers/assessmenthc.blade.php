        ...
        <tr>
            <td>
                ...
                <input type="date" name="interview_date"
                    value="{{ $tr_assessment && $tr_assessment->assessment_date ? \Carbon\Carbon::parse($tr_assessment->assessment_date)->format('Y-m-d') : '' }}" required>
            </td>
            <td></td>
            <td>
                <strong>Jam</strong><br>( Time ) :
                <input type="time" name="interview_time"
                    value="{{ $tr_assessment && $tr_assessment->assessment_date ? \Carbon\Carbon::parse($tr_assessment->assessment_date)->format('H:i') : '' }}" required>
            </td>
            <td></td>
