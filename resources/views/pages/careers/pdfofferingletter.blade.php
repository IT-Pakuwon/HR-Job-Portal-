...
<body>
    ...
    <div
        style="margin-bottom:10px; text-align:
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                ...
                Anda akan didaftarkan pada kepesertaan BPJS Ketenagakerjaan yang meliputi program: Jaminan Hari Tua
                (JHT), Jaminan Kematian (JKM), Jaminan Kecelakaan Kerja (JKK), dan Jaminan Pensiun (JP).<br>
                Anda wajib berkontribusi sebesar 2% dari gaji Anda setiap bulannya untuk program JHT dan kontribusi
                program Jaminan Pensiun sebesar 1% dari Rp. 10.547.400,- (batas maksimal berdasarkan surat dari BPJS
                Ketenagakerjaan nomor: B/91/022025 tanggal 27 Februari 2025).
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                ...
                <ul>
                    <li>Tunjangan Pengobatan 1 (satu) bulan gaji bagi yang masa kerjanya telah mencapai 12 (dua belas)
                        bulan berturut-turut dan proporsional bagi yang telah melewati masa kerja 3 bulan namun belum
                        mencapai 12 (dua belas) bulan masa kerja, dan dikurangi kontribusi aktif BPJS Kesehatan 5% di
                        tiap bulannya.</li>
                    <li>Tunjangan Hari Raya 1 (satu) bulan gaji bagi yang masa kerjanya telah mencapai 12 (dua belas)
                        bulan berturut-turut dan proporsional bagi yang telah melewati masa kerja 1 bulan namun belum
                        mencapai 12 (dua belas) bulan masa kerja.</li>
                </ul>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                ...
                Mendapatkan hak cuti selama 12 (dua belas) hari dalam 1 (satu) tahun masa kerja. Hak cuti dapat diambil
                setelah melampaui 1 (satu) tahun bekerja.
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <p>Apabila Saudara menerima penawaran ini, harap menandatangani turunan surat ini sebagai bukti persetujuan Saudara
        dan mengembalikannya kepada Perusahaan.</p>
