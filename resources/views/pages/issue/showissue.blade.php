<x-app-layout>
        ...
        <div class="flex w-full flex-col gap-6 overflow-hidden sm:col-span-1 lg:row-span-1 xl:row-span-1 xl:flex-col">
                        ...
                        <header
                            ...
                            <nav class="flex flex-grow">
                                <button @click="activeTab = 'attachment'"
                                    ...
                                    class="flex-1 px-4 py-2 text-center text-xs font-medium">Attachment</button>
            ...
            <div class="flex w-full flex-col rounded-xl bg-white dark:bg-gray-800">
                <header
                    ...
                    <h2 class="text-base font-semibold">📦 Issue Detail</h2>
                </header>
    ...
    <script>
        function checkApproval(sppbid, action) {
            $.ajax({
                url: `/approval/${sppbid}/check/${action}?doctype=IS`,
                type: "GET",
                success: function(response) {
