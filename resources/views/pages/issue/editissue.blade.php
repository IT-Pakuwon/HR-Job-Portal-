                        ...
                        <div class="mt-2 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="block text-sm font-medium text-gray-600 dark:text-gray-300">Issue
                                    Date</label>
                                <input type="text"
                                    value="{{ \Carbon\Carbon::parse($iss->issuedate)->format('Y-m-d') }}" readonly
                                    class="mt-1 w-full rounded-lg border border-gray-300 bg-gray-50 p-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200" />
                            </div>
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="mt-6 overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-gray-700">
                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2 text-right">
                                                        <input type="hidden" name="detail_id[]"
                                                            value="{{ $spbDetailId }}">
                                                        <input type="text" name="qty_issue[{{ $spbDetailId }}]"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="8" class="px-4 py-4 text-center text-gray-500 dark:text-gray-400">No
                                                        issue detail</td>
                                                </tr>
                                            @endforelse
