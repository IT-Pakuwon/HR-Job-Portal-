            ...
            <div class="flex flex-col gap-6">
                    ...
                    <details id="sec-jobdetail" open class="group scroll-mt-4 rounded-xl bg-white shadow-sm dark:bg-gray-800">
                        ...
                        <div class="p-4 pt-3">
                            ...
                            <div id="jobTypeRow" class="mb-6 grid grid-cols-1 gap-6 @if(old('job_type', $personnel->job_type) === 'Replacement') md:grid-cols-2 @endif">
                                <div class="flex flex-col gap-2">
                                ...
                                <div id="replacementField" class="@if(old('job_type', $personnel->job_type) === 'Replacement') flex @else hidden @endif flex-col gap-2">
