...
<x-app-layout>
    ...
    <div id="loadingOverlay" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50 hidden">
        <div class="flex flex-col items-center">
            ...
            <p class="text-white mt-2 text-lg font-semibold">Processing...</p>
        </div>
    </div>
        ...
        <div class="grid">
            <div class="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
                <div class="grid grid-cols-12 gap-6">    
                    <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white dark:bg-white-800 rounded-2xl overflow-hidden">
                        <header class="px-6 py-4 bg-white dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $personnel->docid }}</h2>
                        </header>
                        <div class="p-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Company</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="company">{{ $personnel->cpnyid }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Department</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="department">{{ $personnel->departementid }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Job Title</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="job_title">{{ $personnel->job_title }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Level</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="level">{{ $personnel->job_level }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Immediate Superior</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="superior">{{ $personnel->immediate_superior }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">State Position</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="state_position">{{ $personnel->state_position }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Job Type</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="job_type">{{ $personnel->job_type }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Reason for Vacancy</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="reason_vacancy">{{ $personnel->reason_vacancy }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Total Number Required</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="total_required">{{ $personnel->required }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Actual</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="actual">{{ $personnel->actual }}</span>
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">The Actual Number</span>
                                    <span class="text-base font-medium text-gray-900 dark:text-gray-100" id="actual_number">{{ $personnel->total_actual }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                        <header class="flex justify-between items-center px-6 py-4 bg-white dark:bg-gray-700 border-b border-gray-200 dark:border-gray-700">
                            <h2 class="font-semibold text-lg text-gray-800 dark:text-gray-100">Approval</h2>
                            <div class="flex gap-2">
                                <div class="flex items-center gap-1 px-2 bg-green-500/15 text-green-700 text-sm font-medium rounded-md border border-green-700 hover:bg-green-600 hover:text-white transition">
                                ...
                                <div class="flex items-center gap-1 px-2  bg-red-500/15 text-red-700 text-sm font-medium rounded-md border border-red-700 hover:bg-red-600 hover:text-white transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"class="w-4 h-4">
                                ...
                                <div class="flex items-center gap-1 px-2 bg-gray-500/15 dark:text-gray-200 text-sm font-medium rounded-md border border-gray-700 hover:bg-gray-600 hover:text-white transition">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center border-t border-gray-200 dark:border-gray-300 p-2 bg-white dark:bg-gray-200/5 gap-2">
                                <input id="commentInput" type="text" placeholder="Write a comment..."
                                    class="flex-1 p-2 rounded focus:outline-none text-sm bg-gray-100 dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden">
                        ...
                        <div x-data="{ open: false }">
                            ...
                            class="fixed top-0 right-0 w-full h-full md:w-1/3 bg-white shadow-lg p-6 z-50">
                                ...
                                <div class="flex flex-col justify-center w-full mt-6 dark:bg-gray-800 overflow-hidden">
                                    <header class="flex justify-between items-center px-6 pt-4 bg-white dark:bg-gray-700">
                                        <h2 class="font-semibold text-2xl text-gray-500 dark:text-gray-100">Approval</h2>
                                        <div class="flex gap-2">
                                ...
                                <div class="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
                                    <div class="grid gap-6">    
                                                <div class="grid grid-cols-12 gap-6">    
                                                    <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-12 bg-white dark:bg-white-800 rounded-2xl overflow-hidden">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-gray-500 dark:text-gray-400">Company:</span>
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-100" id="company">{{ $personnels->cpnyid }}</span>
                            </div>
                        </header>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-1">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Department</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->departementid }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Job Title</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->job_title }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Job Type</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->job_type }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Level</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->job_level }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">State Position</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->state_position }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-sm text-gray-500 dark:text-gray-400">Immediate Superior</span>
                                        <p class="text-base font-medium text-gray-900 dark:text-gray-100">{{ $personnels->immediate_superior }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 gap-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center gap-3">
                                    <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">Total Required</span>
                                    <span class="text-base text-gray-900 dark:text-gray-100">{{ $personnels->required }}</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">Actual</span>
                                    <span class="text-base text-gray-900 dark:text-gray-100">{{ $personnels->actual }}</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">Actual Number</span>
                                    <span class="text-base text-gray-900 dark:text-gray-100">{{ $personnels->total_actual }}</span>
                                </div>
                            </div>
                    
                            <!-- Reason for Vacancy -->
                            <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 font-semibold">
                                    Reason for Vacancy
                                </div>
                                <span class="text-base font-medium text-gray-900 dark:text-gray-100 mt-2">{{ $personnels->reason_vacancy }}</span>
                            </div>
                        </div>
                    </div>
