                            ...
                            <div class="flex flex-col rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                <header
                                    ...
                                    <div class="flex w-full justify-between gap-2">
                                        <h1 class="text-xl font-semibold text-gray-700 dark:text-gray-100">🆔
                                            {{ $personnel->docid }}</h1>
                                        <span
                                            class="text-l @if ($personnel->status === 'D') bg-gray-300/30 text-gray-600
                                ...
                                <div class="p-4">
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-6">
                                            <div class="grid-row-1 md:grid-row-2 grid gap-6">
                                                @php
                                                    $jobDetail = [
                                                        [
                                                            'icon' => 'clipboard-list',
                                            ...
                                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                                ...
                                                @foreach ($jobNumbers as $job)
                                                    <div
                                                        ...
                                                        <span class="whitespace-nowrap">{{ $job['label'] }}:</span>
                                                        <span
                                                            class="text-indigo-600 dark:text-indigo-400">{{ $job['value'] }}</span>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col md:flex-row md:items-center md:gap-4">
                                                <h3
                                                    class="mb-3 flex items-center gap-2 text-lg font-semibold text-gray-700 md:mb-0 dark:text-gray-200">
                                                    <span class="text-2xl">🏷️</span>
                                                    Tags
                                                </h3>
                                                <div x-data="{ isOpen: true }" class="flex max-w-full flex-wrap gap-3">
                                                    @foreach ($jobtag as $jt)
                                                        <span
                                                            class="inline-block cursor-pointer rounded-full bg-indigo-100 px-4 py-1.5 text-sm font-semibold text-indigo-700 shadow-sm transition-all duration-300 hover:bg-indigo-200 hover:shadow-md dark:bg-indigo-700 dark:text-indigo-100 dark:hover:bg-indigo-600">
                                                            {{ $jt->job_tags }}
                                                        </span>
                                                    @endforeach
                                                </div>
                                ...
                                <div x-data="{ isOpen: true }">
                                    <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                        <header
                                            class="flex items-center justify-between border-b border-gray-300/10 px-6 py-4">
                                        ...
                                        <div class="pb-2 pl-6 pr-6 pt-2">
                                            <ul x-show="isOpen" x-transition.opacity
                                                class="max-h-60 space-y-3 overflow-y-auto pr-2 text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="overflow-hidden rounded-2xl bg-white shadow-sm dark:bg-gray-800">
                                        ...
                                        <div class="pb-2 pl-6 pr-6 pt-2">
                                            <ul x-show="isOpen" x-transition.opacity
                                                ...
                                                <div class="mb-2 mt-1 flex flex-row gap-2">
                                                    <li
                                                        class="flex w-1/2 items-center space-x-2 rounded-lg bg-gray-100 px-4 py-2 shadow-sm dark:bg-gray-800">
                                                        <span
                                                            class="text-lg text-indigo-500 dark:text-indigo-400">🎓</span>
                                                        <span class="font-medium">Pendidikan minimum
                                                            {{ $personnel->education }}</span>
                                                    </li>
                                                    <li
                                                        class="flex w-1/2 items-center space-x-2 rounded-lg bg-gray-100 px-4 py-2 shadow-sm dark:bg-gray-800">
                                                        <span
                                                            class="text-lg text-indigo-500 dark:text-indigo-400">💼</span>
                                                        <span class="font-medium">Pengalaman minimum
                                                            {{ $personnel->experience_start }} Tahun
                                                            {{-- {{ $personnel->experience_end }} Tahun</span> --}}
                                                    </li>
                                                </div>
                                                @foreach ($jobqua as $jq)
                                                    <li class="flex items-start space-x-3 pt-2">
                                                        <span class="text-indigo-500 dark:text-indigo-400">•</span>
                                                        <span
                                                            class="font-medium">{{ $jq->job_qualification_descr }}</span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
