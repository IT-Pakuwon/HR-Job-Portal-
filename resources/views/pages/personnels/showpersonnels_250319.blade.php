            ...
            <div
                ...
                <header
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <button @click="open = true" class="rounded px-4 py-2 text-gray-500 dark:text-gray-200">See
                            Details</button>
                        <!-- Modal -->
                        <div x-show="open" x-transition:enter="transform transition ease-in-out duration-300"
                            ...
                            <!-- Your Content -->
                            {{-- Approval --}}
                            <div class="mt-2 flex w-full flex-col justify-center border-b dark:border-gray-200/10">
                                <header class="flex items-center justify-between bg-white px-6 pt-4 dark:bg-gray-700">
                        ...
                        <!-- Background Overlay -->
                        <div x-show="open" @click="open = false" class="fixed inset-0 bg-gray-500/10 bg-opacity-100"
                            x-transition></div>
                    </div>
                </header>
                <!-- Main Content -->
