    ...
    <div class="py-4 w-full max-w-9xl mx-auto">
        <div class="grid">
            <div class="px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
                <div class="gap-6">    
                    <div class="flex flex-col col-span-full sm:col-span-12 xl:col-span-12 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
                        <header class="px-6 py-4 flex justify-between items-center border-b border-gray-300/10 dark:border-gray-600 bg-white dark:bg-gray-700">
                                                    ...
                                                    <tbody>
                                                        @foreach ($attachment as $at)
                                                            ...
                                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                                <td class="p-3">
                                                                    <a href="{{ $fileUrl }}" target="_blank" class="text-gray-300 dark:text-gray-300 hover:underline flex items-center gap-2">📎 {{ $at->name }}</a>
                                                                </td>
                    ...
                    <div x-data="{ isOpen: true }" class="pt-4 pb-4">
                        <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
                            <header class="flex justify-between items-center px-5 py-4 border-b dark:bg-gray-700 border-gray-300/10 dark:border-gray-700">
