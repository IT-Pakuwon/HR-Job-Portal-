<x-app-layout> 
    ...
    <div class="py-1 w-full max-w-9xl mx-auto">
        <div class="grid">
            <div class="px-2 sm:px-6 lg:px-2 py-1 w-full mx-auto">
                <div class="gap-1">    
                    <div class="flex flex-col xl:flex-row sm:col-span-1 lg:row-span-1 xl:row-span-1 gap-2 w-full overflow-hidden">
                        <div class="flex flex-col sm:w-1/2 gap-4">
                            <div class="flex flex-col  bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                <header class="px-6 py-4 flex flex-row justify-between rounded-t-2xl border-b bg-gray-50 border-gray-300/10 dark:border-gray-600">
                                ...
                                <div class="p-4">
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-6 ">
                                            ...
                                            @endphp
                                             @foreach ($jobDetail as $details)
                                                <div class="flex items-center gap-4 p-3 bg-gray-200/10 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                                    <i class="lucide lucide-{{ $details['icon'] }} w-6 h-6 text-gray-600 dark:text-gray-300"></i>
                                                    <div>
                                                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ $details['label'] }}</span>
                                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $details['value'] }}</p>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="grid grid-row-1 md:grid-row-2 gap-6">
                                            @php
                                                $jobDetail2 = [
                                                    ['icon' => 'clipboard-list', 'label' => 'Job Type', 'value' => $personnel->job_level],
                                                    ['icon' => 'user-check', 'label' => 'Immediate Superior', 'value' => $personnel->state_position],
                                                    // ['icon' => 'user-check', 'label' => 'Status', 'value' => $personnel->status],
                                                ];
                                            @endphp
                        ...
                        <div class="flex flex-col w-1/2 gap-4">
                            <div class="dark:bg-gray-800 rounded-xl overflow-hidden max-h-[22%]">
                                <header class="px-6 py-4 flex flex-row justify-between rounded-t-2xl border-b bg-gray-50 border-gray-300/10 dark:border-gray-600 ">
                                ...
                                <div class="flex flex-col w-full border-b dark:border-gray-200/10 overflow-y-auto h-full">
                                    <div class=" bg-white px-4 pt-4 overflow-x-auto">
                            ...
                            <div class="dark:bg-gray-800 rounded-xl overflow-hidden max-h-[22%]">
                                ...
                                <div class="flex flex-col w-full border-b dark:border-gray-200/10 h-full">

                                            <div class=" bg-white px-4 pt-4 overflow-x-auto">
                                        <table class="w-full text-xs mb-4 overflow-y-auto ">
                            ...
                            <div class="dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm">
                                <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-12 border-b dark:border-gray-200/10 overflow-y-auto">
                                    <div x-data="{ isOpen: true, comments: [], newComment: '', currentUser: 'User1' }" class="flex flex-col justify-center w-full">
                                        <header class="px-6 py-4 flex flex-row justify-between rounded-t-2xl border-b bg-gray-50 border-gray-300/10 dark:border-gray-600 ">
                                        ...
                                        <div  class="overflow-hidden bg-white transition-all duration-300">
                                            ...
                                            <div class="flex items-center p-3 border-t border-gray-200 dark:border-gray-700 gap-2">
                                                ...
                                                <button 
                                                    ...
                                                    class="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-lg text-xs font-semibold transition-all duration-200 shadow-md hover:  active:scale-95">
                                                    Post 🚀
                                                </button>
                                            </div>
                                        </div>
