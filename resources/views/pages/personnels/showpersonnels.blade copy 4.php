                        ...
                        <div class="flex flex-col gap-6 sm:w-1/2 md:w-full"> {{-- Increased gap for more breathing room --}}
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col md:flex-row md:items-center md:gap-4">
                                            ...
                                            <div x-data="{ isOpen: true }"
                                                class="mt-2 flex max-w-full flex-wrap gap-3 md:mt-0">
                                                {{-- Added margin-top for mobile, consistent gap --}}
                                                @foreach ($jobtag as $jt)
                                                    <span
                                                        class="inline-block cursor-pointer rounded-full bg-purple-100 px-4 py-1.5 text-xs font-semibold text-purple-700 shadow-sm transition-all duration-300 hover:bg-purple-200 hover:shadow-md dark:bg-purple-800/30 dark:text-purple-300 dark:hover:bg-purple-800">
                            ...
                            <div x-data="{ isOpen: true }"
                                ...
                                <header
                                    ...
                                    <h2
                                        class="flex items-center gap-2 text-base font-bold text-gray-800 dark:text-gray-100">
                                        {{-- Larger, bolder title --}}
                                ...
                                <div x-data="{ comments: [], newComment: '', currentUser: 'User1' }" class="flex w-full flex-col justify-center">
                                    ...
                                    <div
                                        ...
                                        <button id="postCommentBtn"
                                            ...
                                            class="rounded-lg bg-indigo-600 px-5 py-3 text-xs font-semibold text-white shadow-md transition-all duration-200 hover:bg-indigo-700 hover:  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 active:scale-95 dark:focus:ring-offset-gray-800">
                                            Post 🚀
                                        </button>
                                    </div>
                                </div>
