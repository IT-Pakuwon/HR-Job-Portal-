<style>
    ...
    #itrTable tbody tr:hover{
        background:
            rgba(99,102,241,.03);
    }

    .dark #itrTable tbody tr:hover{
        background:
