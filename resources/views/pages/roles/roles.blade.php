<x-app-layout>
    ...
    <div class="max-w-9xl mx-auto w-full p-2">
        <div
            ...
            <div
                ...
                <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">Sys Role List</h2>
            ...
            <div class="relative overflow-hidden">
                <table id="rolesTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
        ...
        <div id="roleModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/50">
            <div class="relative w-full max-w-lg rounded-lg bg-white p-4 dark:bg-gray-700">
                <h2 id="roleModalTitle" class="mb-4 text-base font-bold text-gray-800 dark:text-white">
                    Add Role
                </h2>
                <form id="roleForm">
                    @csrf
    ...
    <div id="loadingOverlay"
        ...
        <div class="bg-white rounded-xl px-6 py-4 shadow-lg flex items-center gap-3 dark:bg-gray-800">
