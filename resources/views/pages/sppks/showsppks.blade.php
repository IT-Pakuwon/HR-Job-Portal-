<x-app-layout>
                            ...
                            <div x-show="activeTab === 'attachment'" class="flex-1 p-2 transition-all">
                                ...
                                <div class="border-t border-gray-200 p-4 dark:border-gray-700">
                                    <form id="sppkAttachmentUploadForm" enctype="multipart/form-data">
                                        ...
                                        <div class="flex-1">
                                            <label for="sppkAttachFiles" class="mb-2 block text-sm font-semibold text-gray-800 dark:text-gray-200">
                                            Upload Attachments
                                            </label>
                                            <div class="flex items-center gap-3">
                                            <input type="hidden" name="cpnyid" value="{{ $sppk->cpny_id }}">
                                            <input type="hidden" name="departementid" value="{{ $sppk->department_id }}">
                                            <input type="file" id="sppkAttachFiles" name="attachments[]" multiple
    ...
    <script>
        ...
        function $tbody() { return $('#sppkAttachmentTbody'); } // <tbody id="sppkAttachmentTbody">
