<x-app-layout>
                ...
                <form id="sppkForm" class="flex flex-col gap-4" enctype="multipart/form-data">
                    ...
                    <div class="w-full rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                        <div class="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
                            <h2 class="text-xl font-extrabold text-gray-800 dark:text-white">Create SPPK</h2>                            
                        </div>
                        ...
                        <!-- ===== Vehicle Section (di bawah Company) ===== -->
                            ...
                            <table class="mb-4 mt-3 w-full">
                                ...
                                <tr class="sppk-row">
                                    ...
                                    <input type="text" name="qty[]" 
                                            class="qtyField w-full border-none bg-transparent p-2 text-right focus:outline-none focus:ring-0" placeholder="0,00" >
                                    </td>
                                    ...
                                    <td class="border p-3 text-center">
                                    <button type="button" class="removeSppk hidden rounded border border-red-700 bg-red-200/10 px-3 py-3 text-white hover:border-red-700 hover:bg-red-400/30">🗑️</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div id="inventoryModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-5xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <button type="button" id="closeInventoryModal" class="rounded px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">✖</button>
                            </div>
                            ...
                            <div class="ml-auto flex items-center gap-2">
                                ...
                                <button id="invRefresh" type="button" class="rounded border px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">↻</button>
                            </div>
                            </div>
                            ...
                            <div class="space-x-2">
                                <button id="invPrev" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="invNext" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="locationModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-3xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <button type="button" id="closeLocationModal" class="rounded px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">✖</button>
                            </div>

                            <div class="mb-3 flex items-center gap-2">
                            <input id="locSearch" type="text" placeholder="Search..." class="rounded border border-gray-300 bg-white px-3 py-1 text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                            <button id="locRefresh" type="button" class="rounded border px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">↻</button>
                            <div class="ml-auto text-sm opacity-80">Company: <span id="locCpnyBadge" class="font-semibold"></span></div>
                            </div>
                            ...
                            <div class="space-x-2">
                                <button id="locPrev" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="locNext" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="subLocationModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-3xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            <div class="mb-3 flex items-center justify-between">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Select Sub Location</h3>
                            <button type="button" id="closeSubLocationModal" class="rounded px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">✖</button>
                            </div>

                            <div class="mb-3 flex items-center gap-2 text-sm">
                            <input id="subLocSearch" type="text" placeholder="Search..." class="rounded border border-gray-300 bg-white px-3 py-1 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                            <button id="subLocRefresh" type="button" class="rounded border px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-700">↻</button>
                            ...
                            <div class="space-x-2">
                                <button id="subLocPrev" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="subLocNext" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="coaModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-4xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <div class="mb-3 flex items-center gap-2 text-sm">
                            <input id="coaSearch" type="text" placeholder="Search code/name..." class="rounded border border-gray-300 bg-white px-3 py-1 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                    ...
                    <div class="w-full max-w-3xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                        ...
                        <div class="space-x-2">
                            <button id="uomPrev" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                            <button id="uomNext" type="button" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                        </div>
                        </div>
                    </div>
                    </div>
    ...
    <script>
        ...
        function clearAllErrors(scope = '#sppkForm') {
        ...
        $(document).on('input change', '#sppkForm input, #sppkForm textarea, #sppkForm select', function () {
        ...
        function validateDetails() {
            ...
            const isEmptyRow =
                !invId && !($qty.val()||'').trim() && !locId && !subId && !coaId;

            if (isEmptyRow) return; // lewati baris kosong

            // baris aktif → semua wajib (kecuali Note)
            let rowErr = false;
            if (!invId) { addError($prod, 'Pilih Product.'); rowErr = true; }
            if (!rawQty || isNaN(qty) || qty <= 0) { addError($qty, 'Qty harus > 0.'); rowErr = true; }
            if (!$uom.val() || $uom.val() === '-') { addError($uom, 'UoM wajib.'); rowErr = true; }
            if (!locId) { addError($locN, 'Pilih Location.'); rowErr = true; }
            if (!subId) { addError($subN, 'Pilih Sub Location.'); rowErr = true; }
            if (!coaId) { addError($coaN, 'Pilih COA.'); rowErr = true; }

            if (!rowErr) validRows++;
            });

            if (validRows === 0) {
            toastr.error('Minimal 1 baris detail harus lengkap (Product, Qty, UoM, Location, Sub Location, COA).');
            return false;
            }

            // scroll ke error pertama jika ada
            const $first = $('#sppkForm .is-invalid').first();
            if ($first.length) {
            $('html,body').animate({ scrollTop: $first.offset().top - 120 }, 300);
            $first.trigger('focus');
            toastr.error('Mohon perbaiki field yang ditandai merah pada detail SPPK.');
            return false;
            }
            return true;
        }
   ...
   <script>
        ...
        function updateRowNumbers() {
            sppkcount = 0;
            $('#sppkTable tr').each(function () {
            sppkcount++;
            $(this).find('td:first').text(sppkcount);
            });
        }
        ...
        $('#addSppk').on('click', function () {
            ...
            <tr class="sppk-row">
                ...
                <button type="button" class="removeSppk bg-red-200/10 hover:border-red-700 hover:bg-red-400/30 border-red-700 border text-white px-3 py-3 rounded hidden">🗑️</button>
                </td>
            </tr>`;
        ...
        function loadInventory() {
            ...
            .fail(function () {
            $tbody.html(`<tr><td colspan="4" class="p-3 text-center text-red-600">Failed to load inventory</td></tr>`);
            $invCount.text('');
        ...
        $(document).on('click', '.chooseInventory', function () {
            ...
            currentRow.find('.productNameField').removeClass('is-invalid').next('.error-feedback').remove();
            currentRow.find('.stock_unitField').removeClass('is-invalid').next('.error-feedback').remove();
    ...
    <script>
        ...
        function loadLocations() {
            ...
            .fail(function () {
            $locTbody.html('<tr><td colspan="3" class="p-3 text-center text-red-600">Failed to load</td></tr>');
            $locCount.text('');
            $('#locPrev, #locNext').prop('disabled', true);
            });
        }
        ...
        $(document).on('click', '.chooseLocation', function () {
            ...
            currentLocRow.find('.locationNameField').removeClass('is-invalid').next('.error-feedback').remove();
    ...
    <script>
        ...
        function loadSubLocations() {
            ...
            $subLocTbody.html('<tr><td colspan="3" class="p-3 text-center">Select company & location first</td></tr>');
            $subLocCount.text('');
            ...
            $subLocTbody.html(rows || '<tr><td colspan="3" class="p-3 text-center">No data</td></tr>');
            subLocState.total = res.total || 0;
            $subLocCount.text(`Showing ${rows ? (res.data.length) : 0} of ${subLocState.total} items`);
            ...
            .fail(function () {
            $subLocTbody.html('<tr><td colspan="3" class="p-3 text-center text-red-600">Failed to load</td></tr>');
            $subLocCount.text('');
            $('#subLocPrev, #subLocNext').prop('disabled', true);
            });
        }
        ...
        $(document).on('click', '.chooseSubLocation', function () {
            ...
            currentSubLocRow.find('.subLocationNameField').removeClass('is-invalid').next('.error-feedback').remove();
    ...
    <script>
        ...
        function closeCoaModal() { $coaModal.addClass('hidden').removeClass('flex'); }
        ...
        $('#coaPrev').on('click', function () {
            if (coaState.page > 1) { coaState.page--; loadCoa(); }
        });
        $('#coaNext').on('click', function () {
            const maxPage = Math.ceil(coaState.total / coaState.per_page);
            if (coaState.page < maxPage) { coaState.page++; loadCoa(); }
        });
    ...
    <script>
        ...
        $(document).on('click', '.chooseUom', function () {
            ...
            currentUomRow.find('.stock_unitField').removeClass('is-invalid').next('.error-feedback').remove();
