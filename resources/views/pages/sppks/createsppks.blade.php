                ...
                <form id="sppkForm" class="flex flex-col gap-4" enctype="multipart/form-data">
                    ...
                    <div id="inventoryModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-5xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <div class="space-x-2">
                                <button id="invPrev" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="invNext" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="locationModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-3xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <div class="space-x-2">
                                <button id="locPrev" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="locNext" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="subLocationModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-3xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <div class="space-x-2">
                                <button id="subLocPrev" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="subLocNext" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="coaModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-4xl rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                            ...
                            <div class="space-x-2">
                                <button id="coaPrev" class="rounded border px-3 py-1 disabled:opacity-40">Prev</button>
                                <button id="coaNext" class="rounded border px-3 py-1 disabled:opacity-40">Next</button>
                            </div>
                            </div>
                        </div>
                    </div>
