        ...
        <div class="grid">
            ...
            <div
                ...
                <div
                    ...
                    <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">📌 Assessments List</h2>
                    <button id="addAppBtn"
                ...
                <div class="relative overflow-hidden">
                    <table id="assessmentsTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                        <thead>
                            <tr
                                class="border-b border-gray-100 bg-gray-50/70 text-[11px] uppercase tracking-[0.08em] text-gray-500 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-gray-400">
                                <th class="w-32 px-4 py-3 text-left font-medium">Actions</th>
                                <th class="px-4 py-3 text-left font-medium">AssessmentID</th>
                                <th class="px-4 py-3 text-left font-medium">AssessmentGroup</th>
                                <th class="px-4 py-3 text-left font-medium">Assessment Descr</th>
                                <th class="px-4 py-3 text-left font-medium">Assessment Score</th>
                                <th class="px-4 py-3 text-left font-medium">Step Order Group</th>
                                <th class="px-4 py-3 text-left font-medium">Step Order</th>
            ...
            <div id="appModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/50">
                <div class="relative w-1/3 rounded-lg bg-white p-4 dark:bg-gray-700">
                    <h2 id="modalTitle" class="mb-4 text-base font-bold text-gray-800 dark:text-white">Add Assessment
                    </h2>
                    <form id="appForm">
