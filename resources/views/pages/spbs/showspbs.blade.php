<x-app-layout>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <input type="hidden" name="departementid"
                                                            value="{{ $spb->department_id }}">
                                                        <input type="file" id="spbAttachFiles"
    ...
    <script>
        function checkApproval(spbid, action) {
            $.ajax({
                url: `/approval/${spbid}/check/${action}?doctype=RB`,
                type: "GET",
                success: function(response) {
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '#btnSaveEditCoa', function() {
                ...
                $.ajax({
                    url: "{{ route('coa.update', $spb->spbid ?? ($spb->id ?? null)) }}",
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
