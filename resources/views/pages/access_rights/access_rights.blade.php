        ...
        <div class="grid">
            ...
            <div class="mt-6 rounded-xl bg-white p-4 dark:bg-gray-800">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">🔐 Access Rights</h2>
                    <button id="addAccessRightBtn" class="rounded-lg bg-indigo-500 px-5 py-2 text-white">
                        + Add Access Right
                    </button>
                </div>
            ...
            <div id="accessRightModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/50">
                ...
                <div class="relative w-full max-w-2xl rounded-lg bg-white p-6 dark:bg-gray-700">
                    <h2 id="accessRightModalTitle" class="mb-4 text-xl font-bold text-gray-800 dark:text-white">
                        Add Access Right
                    </h2>
