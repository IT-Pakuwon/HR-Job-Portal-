<x-app-layout>
    ...
    <meta name="beacon-performance-route" content="{{ route('pgtrek.beacon-performance') }}">
    <meta name="report-summary-route" content="{{ route('pgtrek.report-summary') }}">
    <meta name="export-pdf-route" content="{{ route('pgtrek.export.pdf') }}">
    <script src="{{ asset('assets/js/pgtrek/dashboard.js') }}"></script>
</x-app-layout>
