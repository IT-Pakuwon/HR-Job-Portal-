<div id="responseTicketModal" data-form-modal="true" class="ticket-modal fixed inset-0 z-[9999] hidden p-4">
            ...
            <form id="responseTicketForm" enctype="multipart/form-data" class="flex min-h-0 flex-1 flex-col">
                ...
                <div class="flex-1 space-y-5 overflow-y-auto px-4 py-4 sm:space-y-6 sm:px-6 sm:py-6">
                    ...
                    <div>
                        ...
                        <div id="response_descr_editor" class="rounded-lg border border-slate-200 bg-white dark:border-white/10 dark:bg-[#0b1220]" style="min-height:120px;"></div>
