<div id="completeTicketModal" class="ticket-modal fixed inset-0 z-[80] hidden overflow-y-auto p-3 sm:p-5">
    ...
    <div class="modal-panel relative z-10 mx-auto flex min-h-screen w-full items-center justify-center">
        ...
        <div
            ...
            <div
                ...
                <div class="min-w-0">
                    ...
                    <p class="mt-1 text-xs text-slate-500 dark:text-slate-400 sm:text-sm">
                        Finalize ticket resolution and provide completed solution information.
                    </p>
            ...
            <form id="completeTicketForm" enctype="multipart/form-data" class="flex min-h-0 flex-1 flex-col">

                @csrf

                <input type="hidden" id="complete_ticket_eid" name="eid">
                ...
                <div class="flex-1 space-y-5 overflow-y-auto px-4 py-4 sm:space-y-6 sm:px-6 sm:py-6">
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                Provide final solution, root cause, and completion notes.
                            </p>
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                Upload evidence, screenshots, reports, or completion documents.
                            </p>

                        </div>

                        <label for="complete_attachments"
                            ...
                            <input type="file" id="complete_attachments" name="attachments[]" multiple
                                class="hidden">
                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <div id="complete_existing_attachment_list"
                                class="space-y-3">
                            </div>

                            <div id="complete_new_attachment_list"
                                class="space-y-3">
                            </div>
                ...
                <div
                    ...
                    <button type="submit" id="btnSubmitCompleteTicket"
