<div id="envisionTicketModal" data-form-modal="true" class="ticket-modal fixed inset-0 z-[9999] hidden overflow-y-hidden p-4">
    ...
    <div class="modal-panel relative z-10 mx-auto flex min-h-screen w-full items-center justify-center">
        ...
        <div
            ...
            <div
                ...
                <div class="min-w-0">
                    ...
                    <p class="mt-1 text-xs text-slate-500 dark:text-slate-400 sm:text-sm">
                        Update ticket progress and estimated resolution plan.
                    </p>
                </div>
                <button type="button"
            ...
            <!-- Form -->
            <form id="envisionTicketForm" enctype="multipart/form-data" class="flex min-h-0 flex-1 flex-col">
                @csrf
                <input type="hidden" id="envision_ticket_eid" name="eid">
                ...
                <div class="flex-1 space-y-5 overflow-y-auto px-4 py-4 sm:space-y-6 sm:px-6 sm:py-6">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2">
                        <div
                            ...
                            <div id="envision_ticketid"
                                class="mt-1 text-sm font-semibold text-slate-800 dark:text-white">-</div>
                        </div>
                        <div
                            class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-white/[0.06] dark:bg-white/[0.03]">
                            <div
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            <h3 class="text-sm font-semibold text-slate-800 dark:text-white">Envision Information</h3>
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Provide next action plan and
                    ...
                    <div
                        ...
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <label
                                ...
                                <input type="checkbox" id="envision_use_schedule"
                                    class="h-4 w-4 rounded border-slate-300 text-slate-900 focus:ring-slate-400">
                                <span>Use Schedule</span>
                            </label>
                        </div>
                        <div id="envision_schedule_container" class="grid hidden grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <div class="mb-2 text-sm font-medium text-slate-700 dark:text-slate-200">Estimated Start
                                    Date</div>
                                <input type="datetime-local" id="envision_working_start_date" name="working_start_date"
                                    class="form-input">
                            </div>
                            <div>
                                <div class="mb-2 text-sm font-medium text-slate-700 dark:text-slate-200">Estimated End
                                    Date</div>
                                <input type="datetime-local" id="envision_working_end_date" name="working_end_date"
                                    class="form-input">
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="mb-4">
                            <h3 class="text-sm font-semibold text-slate-800 dark:text-white">Attachment</h3>
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Upload supporting files or
                                screenshots.</p>
                        </div>
                        <label for="envision_attachments"
                            ...
                            <div class="text-left">
                                <p class="text-sm font-semibold text-slate-700 dark:text-slate-200">Upload Attachment
                                </p>
                                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">PDF, DOCX, XLSX, PNG, JPG</p>
                            </div>
                            <input type="file" id="envision_attachments" name="attachments[]" multiple
                                class="hidden">
                        </label>
                ...
                <div
                    ...
                    <button type="submit" id="btnSubmitEnvisionTicket"
