        ...
        <div class="grid">
            ...
            <div class="mt-2 overflow-y-auto rounded-xl bg-white p-4 dark:bg-gray-800">
                <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                    <h1 class="align-middle text-2xl font-bold dark:text-white">Task Management</h1>
                    <a href="{{ url('/createtasks') }}" class="rounded-lg bg-indigo-500 px-5 py-2 text-white">
                        <i class="fas fa-plus pr-2"></i>Create Task</a>
                </div>
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    ...
                                    return `<span style="display:none;">${sortValue}</span><span class="${badgeClass}">${priorityText}</span>`;
                                }
                            },
                            {
                                data: 'status',
