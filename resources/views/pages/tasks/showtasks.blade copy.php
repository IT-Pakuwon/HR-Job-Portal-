        ...
        <div class="grid">
            <div class="mx-auto w-full px-2 py-1 sm:px-6 lg:px-2">
                <div class="flex flex-col gap-2">
                    <div
                        class="flex w-full flex-row gap-2 overflow-hidden sm:row-span-1 lg:row-span-2 xl:row-span-2 xl:flex-col">
                        <div class="flex w-1/2 flex-col rounded-xl bg-white shadow-sm dark:bg-gray-800">
                            <header
                                ...
                                <div class="flex w-full flex-row items-center justify-between">
                                    ...
                                    <span class="{{ $statusClass }} rounded-lg px-3 py-1 text-xs font-semibold">
                                        {{ $statusText }}
                                    </span>
                                </div>
                            ...
                            <div class="p-4">
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                                        @php
                                            $jobDetails = [
                                                ...
                                                [
                                                    'icon' => 'building',
                                                    'label' => 'Department',
                                                    'value' => $task->departementid,
                                                ],
                                                ['icon' => 'briefcase', 'label' => 'Type', 'value' => $task->tasktype],
                                                [
                                                    'icon' => 'briefcase',
                                                    'label' => 'Priority',
                                        ...
                                        {{-- Participant + Start Date + Due Date as full-width --}}
                                        <div class="col-span-1 grid grid-cols-1 gap-4 md:col-span-4 md:grid-cols-3">
                                            {{-- Participant / Assign --}}
                                            <div
                                        ...
                                        {{-- Summary - Full width --}}
                                        <div
                                            class="col-span-1 flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-200/10 p-3 md:col-span-4 dark:border-gray-700 dark:bg-gray-800">
                                            <i
                        ...
                        <div class="w-1/2 rounded-xl bg-white shadow-sm">
                            <div class="flex max-h-96 min-h-[12rem] flex-col rounded-xl dark:bg-gray-800">
                                ...
                                <div class="overflow-x-auto bg-white px-4 pt-2">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-4 sm:w-1/2 md:w-1/2">
                            <div class="flex max-h-96 min-h-[12rem] flex-col rounded-xl dark:bg-gray-800">
                                <header
                                    class="flex flex-row justify-between rounded-t-2xl border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-600">
                                    <h2 class="text-base font-semibold text-gray-600 dark:text-gray-100"> 🚀 Approval</h2>
                                    <div class="flex gap-2">
                                        <div
                        ...
                        <div class="rounded-xl bg-white shadow-sm xl:w-1/2">
                            <div class="mt-4 flex w-full flex-col justify-center xl:mt-0">
                                <header
                                    class="flex flex-row justify-between rounded-t-2xl border-b border-gray-300/10 bg-gray-50 px-6 py-4 dark:border-gray-600">
                                    <h2
                                ...
                                <div class="overflow-hidden transition-all duration-300">
                                    ...
                                    <div
                                        ...
                                        <button id="postCommentBtn"
                                            class="rounded-lg bg-indigo-500 px-4 py-2 text-xs font-semibold text-white shadow-md transition-all duration-200 hover:bg-indigo-600 hover:  active:scale-95">
                                            Post 🚀
                                        </button>
                                    </div>
                                </div>
                ...
                function approvePersonnel(docid) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 403) {
                                toastr.error("You are not authorized to approve this task.");
                            } else {
                                toastr.error("Error: Unable to approve task.");
                            }
                        },
                        complete: function() {
            ...
            <script>
                function checkApproval(docid, action) {
                    ...
                    $.ajax({
                        url: `/task/${docid}/check-approval/${action}`,
                        type: "GET",
                        success: function(response) {
                            if (response.canPerformAction) {
                                ...
                                toastr.error("You are not authorized to " + action + " this task.");
                            }
                        },
                        error: function() {
