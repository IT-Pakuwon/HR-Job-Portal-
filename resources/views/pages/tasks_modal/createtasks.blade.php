<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mt-2 mb-2 bg-white  dark:bg-gray-800 p-6 rounded-xl">
            <h2 class="text-2xl font-bold mb-4 mt-6 bg-white">Create Tasks</h2>
            <form id="taskForm" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-gray-700 font-semibold">Company</label>
                        <select class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300" name="cpnyid" required>
                    ...
                    <div>
                        ...
                        <select class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300" name="departementid" required>
                    ...
                    <div>
                        ...
                        <select class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300" name="tasktype" required>
                    ...
                    <div>
                        ...
                        <textarea name="summary" id="summary" class="w-full p-2 border rounded"></textarea>
                    </div>
                    ...
                    <div>
                        <label class="block text-gray-700 font-semibold">Participant</label>
                        {{-- <select class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300" name="participant" required> --}}
                        <select class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300 select2" name="participant[]" multiple required>
                    ...
                    <div>
                        ...
                        <input type="date" name="startdate" id="startdate" class="w-full p-2 border rounded">
                    </div>
                    <div>
                        <label class="block text-gray-700">Due Date</label>
                        <input type="date" name="duedate" id="duedate" class="w-full p-2 border rounded">
                    </div>                    
                </div>
