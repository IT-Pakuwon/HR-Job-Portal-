        ...
        <div class="grid">
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ url('/createtasks') }}" class="px-5 py-2 bg-indigo-500 text-white rounded-lg">+ Create Tasks</a>
                </div>
            
                <table id="tasksTable" class="w-full border-collapse table-fixed">
                ...
                $(document).ready(function () {
                    let table = $('#tasksTable').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'summary',className: 'no-pointer' },
                            { data: 'taskpriority',className: 'no-pointer',
                                render: function (data) {
                                    ...
                                    if (data === 'Highest') {
                                        ...
                                        badgeClass = "bg-red-300/30 dark:bg-red-300 text-red-500 dark:text-red-800 font-semibold focus:outline-none pointer-events-none border-none px-4 py-2 rounded-full";
                                    } else if (data === 'High') {
                                        priorityText = "High";
                                        badgeClass = "bg-red-300/30 dark:bg-red-300 text-red-500 dark:text-red-800 font-semibold focus:outline-none pointer-events-none border-none px-4 py-2 rounded-full";
                                    } else if (data === 'Medium') {
                                        priorityText = "Medium";
                                        badgeClass = "bg-yellow-300/30  dark:bg-yellow-300 text-yellow-600 dark:text-yellow-800 font-semibold  focus:outline-none pointer-events-none border-none px-4 py-2 rounded-full";
                                    } else if (data === 'Low') {
                                        priorityText = "Low";
                                        badgeClass = "bg-blue-300/30  dark:bg-bluee-300 text-blue-600 dark:text-blue-800 font-semibold  focus:outline-none pointer-events-none border-none px-4 py-2 rounded-full";
                                    } else if (data === 'Lowest') {
                                        priorityText = "Lowest";
                                        badgeClass = "bg-green-300/30  dark:bg-green-300 text-green-600 dark:text-green-800 font-semibold  focus:outline-none pointer-events-none border-none px-4 py-2 rounded-full";
                                    }
