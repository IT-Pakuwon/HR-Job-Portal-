<x-app-layout>
    <style>
    tfoot td { background:#fafafa; }          /* warna abu muda */
    .sum-total, .sum-grand, .sum-selected{    /* angka rata‑kanan */
...
<div class="p-4">
    ...
    <div class="overflow-x-auto">
        <table id="cvTable" class="table-auto w-max whitespace-nowrap border">
            <thead>
            ...
            <tbody id="cvBody">
                @foreach ($items as $row)
                    <tr>
                        ...
                        <td class="border px-3 py-2 text-center qty" data-qty="{{ $row->qty }}">{{ $row->qty }}</td>
        ...
        <p id="emptyMsg" class="text-sm italic text-gray-500 mt-2">
