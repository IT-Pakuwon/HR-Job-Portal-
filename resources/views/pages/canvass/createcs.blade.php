                            ...
                            <div class="grid grid-cols-1 gap-4 md:col-span-1 md:grid-cols-2">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <textarea name="csnote" id="csnote"
                                        class="h-35 w-full rounded-md border border-gray-300 bg-white p-3 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"></textarea>
                                </div>
        ...
        >
                    ...
                    <div class="flex items-center gap-1 font-bold text-gray-800 dark:text-gray-100 break-words">
                        ...
                        <div class="relative group inline-block">
                            ...
                            <div class="pointer-events-none absolute left-1/2 top-full z-50 mt-2 
                                        w-64 -translate-x-1/2 rounded-md bg-gray-900 p-3  text-sm  
                ...
                <button type="button"
                    class="btn-del absolute top-1 right-1 flex h-5 w-5 items-center justify-center 
                        rounded-full bg-red-600  text-sm  text-white shadow hover:bg-red-700"
                    data-id="${id}">
                    ✕
                </button>
                    </th>
                ...
                const $sumTd = $(`
                    <td id="td-sum-${id}" 
                        class="border px-3 py-2  text-sm  align-top"
                        ...
                        <div class="flex flex-col gap-2 text-gray-700 dark:text-gray-200">
                            ...
                            <div class="flex justify-between gap-2">
                                ...
                                <div class="flex items-center gap-1 rounded-md bg-gray-100 px-2 py-1 dark:bg-gray-700">
                                    ...
                                    <input type="number" 
                                        class="sum-ppn tax-input w-16 rounded border border-gray-300 px-1 text-right  text-sm  focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200"
                                        value="11.00" step="0.01" min="0">
                                    <button type="button" 
                                        class="btn-pick-tax rounded bg-indigo-100 px-1  text-sm  text-indigo-700 hover:bg-indigo-200 dark:bg-indigo-800 dark:text-white dark:hover:bg-indigo-700"
                                ...
                                <div class="flex items-center gap-1 rounded-md bg-gray-100 px-2 py-1 dark:bg-gray-700">
                                    ...
                                    <input type="number" 
                                        class="sum-pph tax-input w-16 rounded border border-gray-300 px-1 text-right  text-sm  focus:border-indigo-500 focus:ring focus:ring-indigo-500/50 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200"
