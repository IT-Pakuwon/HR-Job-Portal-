                                        ...
                                        <td class="border px-4 py-3 align-top">
                                            <div class="grid grid-cols-2 gap-3 text-xs">
                                                <label class="flex flex-col gap-1">
                                                    <span class="font-medium text-gray-600 dark:text-gray-300">Total Material</span>
                                                ...
                                                <label class="flex flex-col gap-1">
                                                    <span class="font-medium text-gray-600 dark:text-gray-300">Total Jasa</span>
                                                    <input type="number" step="0.01" min="0"
                                ...
                                @foreach ($vendors as $i => $v)
                                    <td class="border px-4 py-4 text-right">
                                        <div class="text-xs text-gray-600 dark:text-gray-300">
                                            Material: <span class="sum-mat font-semibold" data-vendor="{{ $i + 1 }}">0</span>
                                        </div>
                                        <div class="text-xs text-gray-600 dark:text-gray-300">
                                            Jasa: <span class="sum-jsa font-semibold" data-vendor="{{ $i + 1 }}">0</span>
                                        </div>
