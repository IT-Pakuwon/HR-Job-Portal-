<x-app-layout>
    ...
    <script>
        ...
        function renderRows(rows) {
            ...
            if (!rows.length) {
                nsTbody.innerHTML = `<tr><td colspan="5" class="px-4 py-10 text-center text-gray-500">No data.</td></tr>`;
                nsChkAll.checked = false;
                nsChkAll.indeterminate = false;
                nsChkAll.disabled = true;
                return;
            ...
            nsTbody.innerHTML = rows.map(r => {
                ...
                return `
                    <tr class="${trClass}">
                        ...
                        <td class="px-3 py-2">
                            <span class="px-2 py-1 rounded text-sm font-semibold ${getStatusBadgeClass(stage)}">
                                ${stage}
                            </span>
                        </td>
            ...
            // row checkbox listener untuk update select all state
        ...
        document.getElementById('btnLoadNonStock').addEventListener('click', async () => {
            ...
            try {
                ...
                // info lebih jelas: show count ready
        ...
        document.getElementById('btnProcessNonStock').addEventListener('click', async () => {
            ...
            // ambil hanya yang checked & bukan C (karena C disable, aman juga)
            ...
            try {
                ...
                // auto reload biar status update
