                       ...
                       <div class="p-4">
                           <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                               ...
                               @foreach ($jobDetails as $detail)
                                   <div
                                       class="flex items-center gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4 transition-shadow duration-200 hover:shadow-md dark:border-gray-700 dark:bg-gray-700/50">
                               ...
                               <div
                                   class="grid grid-cols-1 gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4 transition-shadow duration-200 hover:shadow-md sm:grid-cols-2 dark:border-gray-700 dark:bg-gray-700/50">
