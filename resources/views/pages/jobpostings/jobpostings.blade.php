    ...
    <div class="px-2 sm:px-6 lg:px-2 w-full py-0 max-w-9xl mx-auto">
        ...
        <div class="grid">
            <style>
                ...
                #jobpostingsTable th, #jobpostingsTable td {
            ...
            <style>
                ...
                #jobpostingsTable th:nth-child(1), #jobpostingsTable td:nth-child(1) {
                    width: 120px;
                    text-align: center;
                }
                #jobpostingsTable th:nth-child(4), #jobpostingsTable td:nth-child(4) {
                    width: 120px;
                    text-align: center;
                }
            </style>
            ...
            <script>
                $(document).ready(function () {
                    let table = $('#jobpostingsTable').DataTable({
                        ajax: "{{ route('jobpostings.json') }}?status=P",
                        processing: true,
                        serverSide: false,
                        responsive: true,
                        order: [[0, 'desc']],                       
                        columns: [
                            ...
                            { data: 'date',className: 'no-pointer' },
