    ...
    <div class="max-w-9xl mx-auto w-full p-2">
        ...
        <div
            ...
            <div
                ...
                <div>
                    <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">💳 Terms Of
                        Payment (TOP)</h2>
            ...
            <div class="relative overflow-hidden">
                <table id="topTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
                            class="border-b border-gray-100 bg-gray-50/70 text-[11px] uppercase tracking-[0.08em] text-gray-500 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-gray-400">
                            <th class="w-10 px-4 py-3"></th>
                            <th class="w-28 px-4 py-3 text-left font-medium">Actions</th>
                            <th class="px-4 py-3 text-left font-medium">TOP ID</th>
                            <th class="px-4 py-3 text-left font-medium">TOP Name</th>
                            <th class="px-4 py-3 text-left font-medium">Type</th>
                            <th class="px-4 py-3 text-left font-medium">Days</th>
                            <th class="w-24 px-4 py-3 text-left font-medium">RFCA</th>
                            <th class="w-24 px-4 py-3 text-left font-medium">Fast</th>
        ...
        <div
            ...
            <div
                class="flex flex-row items-start justify-between gap-4 border-b border-gray-100 px-5 py-2 dark:border-white/[0.06] sm:flex-row sm:items-center">
                <div>
                    <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">🧾 TOP
                        Detail</h2>
            ...
            <div class="relative overflow-hidden">
                <table id="topDetailTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
                            class="border-b border-gray-100 bg-gray-50/70 text-[11px] uppercase tracking-[0.08em] text-gray-500 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-gray-400">
                            <th class="w-10 px-4 py-3"></th>
                            <th class="w-28 px-4 py-3 text-left font-medium">Actions</th>
                            <th class="px-4 py-3 text-left font-medium">Terms ID</th>
                            <th class="px-4 py-3 text-left font-medium">Terms Name</th>
                            <th class="px-4 py-3 text-left font-medium">Order</th>
                            <th class="px-4 py-3 text-left font-medium">Pay %</th>
                            <th class="px-4 py-3 text-left font-medium">Prog %</th>
                            <th class="px-4 py-3 text-left font-medium">Type</th>
                            <th class="w-24 px-4 py-3 text-left font-medium">BAST</th>
                            <th class="w-28 px-4 py-3 text-left font-medium">Status</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
