<x-app-layout>
    ...
    <div class="max-w-9xl mx-auto p-2">
        <x-breadcrumb :items="[
            ...
            ['label' => 'Parking Registration', 'url' => route('parkingregistration')],
            ['label' => 'Show Details'],
        ]">
            <x-approval-actions
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ $isChangeNopol ? 11 : 9 }}" class="p-4 text-center italic text-gray-500 dark:text-gray-400">
                                        No detail found.
                                    </td>
                                </tr>
                            @endforelse
    ...
    <script>
        $(document).ready(function() {
            ...
            attachMentionAutocomplete({
                ...
                fetchUrlFn: () => `/mentionable-users/${doctype}/${docid}`,
            });
