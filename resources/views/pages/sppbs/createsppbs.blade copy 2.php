                                        ...
                                        <table class="mb-4 mt-3 w-full">
                                            <thead class="bg-gray-100/10">
                                                <tr>
                                                    ...
                                                    <th class="req w-28 w-[8%] border p-3">SiteID</th>
                                                ...
                                                title="Lookup">🔎</button>
                                                    ...
                                                    <td class="border p-3">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <input type="text" name="coa[]" class="coaNameField w-full border-none bg-transparent p-2 focus:outline-none focus:ring-0"
                    ...
                    <div id="modalLokasi" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/50 p-4">
                        <div class="w-full max-w-2xl rounded-xl bg-white shadow-xl dark:bg-gray-800">
                            ...
                            <div class="flex items-center gap-3">
                                <h3 class="text-sm font-bold text-gray-800 dark:text-gray-100">Pilih Location & Sub Location</h3>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <!-- Location -->
                                <div>
                                <label class="req mb-1 block text-xs font-medium text-gray-700 dark:text-gray-300">Location</label>
                                ...
                                <!-- Sub Location -->
                                <div>
                                <label class="req mb-1 block text-xs font-medium text-gray-700 dark:text-gray-300">Sub Location</label>
    ...
    <script>
        ...
        function openLokasiModal(forRow) {
            ...
            .done(function(list){
                ...
                if (curLoc) { $selLoc.val(curLoc).trigger('change'); }

                // ✅ fokuskan ke Location
                setTimeout(()=> $selLoc.trigger('focus'), 0);
            })
            .fail(function(){ toastr.error('Gagal memuat lokasi.'); });
