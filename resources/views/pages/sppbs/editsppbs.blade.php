        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:grid-rows-[minmax(0,auto)_1fr]">
            <div class="flex flex-col gap-8 lg:col-span-2 lg:row-span-1">
                ...
                <form id="sppbForm" class="flex flex-col gap-4" enctype="multipart/form-data"
                      action="{{ route('sppbs.update', $sppb->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select id="perpost" name="perpost"
                                        class="w-full rounded-lg border border-gray-300 bg-white p-2.5 text-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"
                                        required>
                                    <option value="{{ $year }}" {{ (string)$sppb->budget_perpost === (string)$year ? 'selected' : '' }}>{{ $year }}</option>
                                    <option value="{{ $year + 1 }}" {{ (string)$sppb->budget_perpost === (string)($year+1) ? 'selected' : '' }}>{{ $year + 1 }}</option>
                                </select>
                            </div>
                        </div>
                                        ...
                                        <table class="mb-4 mt-3 w-full">
                                            ...
                                            @forelse ($sppbdetail as $d)
                                                ...
                                                <tr class="sppb-row" data-detail-id="{{ $d->id }}">
                                                    ...
                                                    <td class="border p-3 text-center">
                                                        <button type="button" class="removeSppb rounded border border-red-700 bg-red-200/10 px-3 py-3 text-red-700 hover:bg-red-400/30">🗑️</button>
                                                    </td>
                                                </tr>
                                            @empty
                                                ...
                                                <tr class="sppb-row">
                                                    ...
                                                    <td class="border p-3 text-center">
                                                        <button type="button" class="removeSppb rounded border border-red-700 bg-red-200/10 px-3 py-3 text-red-700 hover:bg-red-400/30 hidden">🗑️</button>
                                                    </td>
                                                </tr>
                                            @endforelse
                                            </tbody>
