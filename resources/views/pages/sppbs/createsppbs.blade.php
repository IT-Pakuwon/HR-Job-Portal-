<x-app-layout>
    ...
    <script>
        ...
        $('#sppbForm').on('submit', function (e) {
            ...
            // --- Validasi minimal: pastikan ada minimal 1 baris detail valid
            const rows = [];
            let hasError = false;
            ...
            success: function (res) {
                ...
                // reset form (opsional)
                // document.getElementById('sppbForm').reset();
   ...
   <script>
        ...
        $('#addSppb').on('click', function () {
            ...
            <tr class="sppb-row">
                ...
                <td class="p-3 border">
                <input type="text" name="stock_unit[]" readonly
                        class="stock_unitField w-full cursor-not-allowed border-none bg-gray-50 p-2 text-gray-600 focus:outline-none" placeholder="-">
                </td>
