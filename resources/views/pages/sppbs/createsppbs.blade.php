                ...
                <form id="sppbForm" class="flex flex-col gap-4" enctype="multipart/form-data">
                    ...
                    <div class="w-full rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Request
                                    Type</label>
                                        ...
                                        <table class="mb-4 mt-3 w-full">
                                            <thead class="bg-gray-100/10">
                                                <tr>
                                                    ...
                                                    <th class="w-[20%] border p-3">Product Name</th>
                                                ...
                                                <tr class="sppb-row">
                                                    ...
                                                    <td class="border p-3">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <button type="button"
                                                                class="openInventoryModal rounded border border-gray-500 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                title="Lookup">🔎</button>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="border p-3">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <button type="button"
                                                                class="openLocationModal rounded border border-gray-500 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                title="Lookup">🔎</button>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="border p-3">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <button type="button"
                                                                class="openSubLocationModal rounded border border-gray-500 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                title="Lookup">🔎</button>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="border p-3">
                                                        <div class="flex items-center gap-2">
                                                            ...
                                                            <button type="button"
                                                                class="openCoaModal rounded border border-gray-500 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
                                                                title="Lookup">🔎</button>
                                                        </div>
                                                    </td>
                    ...
                    <div id="inventoryModal"
                        ...
                        <div class="w-full max-w-5xl rounded-xl bg-white p-4 dark:bg-gray-800">
                    ...
                    <div id="locationModal"
                        class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-3xl rounded-xl bg-white p-4 dark:bg-gray-800">
                            <div class="mb-3 flex items-center justify-between">
                    ...
                    <div id="coaModal"
                        class="fixed inset-0 z-[1000] hidden items-center justify-center bg-black/40 p-4">
                        <div class="w-full max-w-4xl rounded-xl bg-white p-4 dark:bg-gray-800">
                            <div class="mb-3 flex items-center justify-between">
