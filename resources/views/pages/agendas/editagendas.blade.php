                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <select id="taskpriority" name="taskpriority"
                                            class="w-full rounded-sm border border-gray-200/50 bg-gray-200/10 p-3 focus:ring focus:ring-blue-300 dark:bg-gray-800"
                                            required>
                                            <option value="" {{ $task->taskpriority == '' ? 'selected' : '' }}>
                                            </option>
                                            <option value="Highest"
                                                {{ $task->taskpriority == 'Highest' ? 'selected' : '' }}>Highest
                                            </option>
                                            <option value="High"
                                                {{ $task->taskpriority == 'High' ? 'selected' : '' }}>High</option>
                                            <option value="Medium"
                                                {{ $task->taskpriority == 'Medium' ? 'selected' : '' }}>Medium</option>
                                            <option value="Low"
                                                {{ $task->taskpriority == 'Low' ? 'selected' : '' }}>Low</option>
                                            <option value="Lowest"
                                                {{ $task->taskpriority == 'Lowest' ? 'selected' : '' }}>Lowest</option>
                                        </select>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <label
