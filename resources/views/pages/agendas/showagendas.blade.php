        ...
        <div class="grid">
                                    ...
                                    <header
                                        ...
                                        <div class="flex max-w-5xl justify-end gap-10">
                                            <h1 class="text-base font-semibold text-gray-700 dark:text-gray-100">🆔
                                                {{ $agenda->docid }}</h1>
                                            <span
                                                class="text-l @if ($agenda->status === 'D') bg-gray-300/30 text-gray-600
                                            @elseif($agenda->status === 'P') bg-blue-300/30 text-blue-600
                                            @elseif($agenda->status === 'C') bg-green-300/30 text-green-600
                                            @elseif(in_array($agenda->status, ['X', 'R'])) bg-red-300/30 text-red-600
                                        ...
                                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            @php
                                                $jobDetails = [
                                                    ...
                                                    [
                                                        'icon' => 'user-check',
                                                        'label' => 'Participant',
                                                        'value' => $agenda->participant,
                                                    ],
                                                    // ['icon' => 'user-check', 'label' => 'Status', 'value' => $agenda->status],
                                                ];
                                            @endphp
                                            ...
                                            @foreach ($jobDetails as $detail)
                                                <div
                                                    ...
                                                    <div class="min-w-0">
                                                        <span
                                                            class="whitespace-normal break-words text-xs text-gray-500 dark:text-gray-400">{{ $detail['label'] }}</span>
                                                        <p
                                                            class="whitespace-normal break-words text-sm font-medium text-gray-900 dark:text-gray-100">
                                                            {{ $detail['value'] }}</p>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <span class="text-xs text-gray-500 dark:text-gray-400">End
                                                            Date</span>
                                                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                            {{ $agenda->enddate }}</p>
                                                    </div>
            ...
            <div id="rejectAgendaModal"
                ...
                <div class="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-700">
                    <h2 class="mb-4 text-base font-semibold text-gray-800 dark:text-white">Reject Agenda</h2>
            ...
            <div id="reviseAgendaModal"
                class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/50">
                <div class="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-700">
                    <h2 class="mb-4 text-base font-semibold text-gray-800 dark:text-white">Revise Agenda</h2>
            ...
            <script>
                $(document).ready(function() {
                    let docid = "{{ $agenda->docid }}"; // Ambil agenda ID dari PHP ke JavaScript
                    loadComments(docid);
                ...
                function approvePersonnel(docid) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 403) {
                                toastr.error("You are not authorized to approve this agenda.");
                            } else {
                                toastr.error("Error: Unable to approve agenda.");
                            }
                        },
                        complete: function() {
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on("click", "#rejectBtn", function() {
                        ...
                        // $("#rejectAgendaModal").removeClass("hidden").css("z-index", "60");
                        let docid = "{{ $agenda->docid }}";
                    ...
                    $(document).on("click", "#cancelRejectBtn", function() {
                        $("#rejectAgendaModal").addClass("hidden");
                    });

                    // Saat tombol "Reject" ditekan, proses perubahan status
                    $(document).on("click", "#confirmRejectBtn", function() {
                        let docid = "{{ $agenda->docid }}"; // Ambil ID tugas dari modal detail
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    // alert("Agenda has been rejected successfully.");

                                    // Update status di modal agenda
                            ...
                            error: function(xhr) {
                                ...
                                if (xhr.status === 403) {
                                    ...
                                    alert("Error: Unable to reject agenda status.");
                                }
                            },
                        });
                    });
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on("click", "#reviseBtn", function() {
                        ...
                        // $("#reviseAgendaModal").removeClass("hidden").css("z-index", "60");
                        let docid = "{{ $agenda->docid }}";
                    ...
                    $(document).on("click", "#cancelReviseBtn", function() {
                        $("#reviseAgendaModal").addClass("hidden");
                    });
                    ...
                    $(document).on("click", "#confirmReviseBtn", function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    // alert("Agenda has been reviseed successfully.");
                            ...
                            error: function(xhr) {
                                ...
                                if (xhr.status === 403) {
                                    ...
                                    alert("Error: Unable to revise agenda status.");
                                }
                            },
                        });
                    });
            ...
            <script>
                function checkApproval(docid, action) {
                    ...
                    $.ajax({
                        url: `/agenda/${docid}/check-approval/${action}`,
                        type: "GET",
                        success: function(response) {
                            if (response.canPerformAction) {
                                ...
                                toastr.error("You are not authorized to " + action + " this agenda.");
                            }
                        },
                        error: function() {
