                ...
                <div class="flex flex-col overflow-y-auto rounded-xl bg-white dark:bg-gray-800">
                    <header
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ url('/pdf_bq_pt') }}/{{ $hash }}" target="_blank">
                                <button
                        ...
                        <form id="bqAttachmentUploadForm" enctype="multipart/form-data"
                            ...
                            <div class="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Max 10 files, PDF / Image
                                        preferred.</p>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        $(function() {
            ...
            function cardTpl(at) {
                ...
                ${at.url ? `<a href="${href}" target="_blank" class="rounded bg-white p-1  text-sm  shadow hover:bg-gray-100 dark:bg-gray-700" title="Open">🔍</a>` : ''}
                ${at.url ? `<a href="${href}" download class="rounded bg-white p-1  text-sm  shadow hover:bg-gray-100 dark:bg-gray-700" title="Download">⬇️</a>` : ''}
                ${canEdit && at.id ? `<button type="button" class="btn-del-attachment rounded bg-white p-1  text-sm  shadow hover:bg-gray-100 dark:bg-gray-700" data-id="${at.id}" title="Delete">🗑️</button>` : ''}
                </div>
            `;
