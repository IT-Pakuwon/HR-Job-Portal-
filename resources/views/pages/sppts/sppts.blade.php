    ...
    <div class="max-w-9xl mx-auto w-full px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="grid">
            <style>
                ...
                #spptsTable_filter label {
                    margin-right: 2px;
                }

                #spptsTable_filter input {
                    width: auto;
                    padding: 5px;
                    min-width: 80px;
                ...
                #spptsTable_length select option {
                    padding: 5px;
                }
                ...
                #spptsTable tbody tr:hover {
                    background-color: #8f8f8f11;
                    opacity: 100%;
                    cursor: pointer;
                }

                #spptsTable tbody tr:hover td {
                    /* color: black; */
                }

                #spptsTable th:nth-child(1),
                #spptsTable td:nth-child(1) {
                    width: 120px;
                    text-align: center;
                }

                #spptsTable th:nth-child(4),
                #spptsTable td:nth-child(4) {
                    width: 120px;
                    text-align: center;
                }

                /* --- Custom Styles for RowGroup Collapse/Expand (Applied to spptsTable) --- */
                /* Initially hide rows in collapsed groups */
                #spptsTable tbody tr.collapsed-group-row {
                    display: none;
                }

                /* Style for group rows */
                #spptsTable tr.group-row {
                ...
                #spptsTable tr.group-row:hover {
                    background-color: #d4d4d4;
                    /* Slightly darker on hover */
                }

                /* Icon styling */
                #spptsTable tr.group-row .fas {
                    margin-right: 8px;
                    width: 16px;
                ...
                #spptsTable tr.group-row td:first-child {
                    border-left: none;
                }
            ...
            <div class="mt-6 rounded-2xl bg-white dark:bg-gray-800">
                ...
                <div class="overflow-x-auto p-6"> {{-- Padding applied here instead of outer container --}}
                    <table id="spptsTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
