                    ...
                    <form id="bqForm" action="{{ $bq ? route('bqsppt.import.edit', $bq->id) : route('bqs.import') }}"
                        ...
                        <div class="rounded-xl border bg-white p-4 shadow dark:bg-gray-800">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div class="flex items-center gap-4">
                                    <label class="mb-1 block text-sm text-gray-500 dark:text-gray-400">SPPT ID</label>
                                    <input
                                        class="w-full rounded-md border bg-gray-50 p-2.5 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                                                ...
                                                <div id="existingAttachments"
                                                    ...
                                                    @forelse ($attachment as $at)
                                                        @php
                                                            ...
                                                            $ext = strtolower(
                                                                pathinfo($at->attachfile, PATHINFO_EXTENSION),
                                                            );
                                                            $isImg = in_array($ext, [
                                                                'jpg',
                                                                'jpeg',
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="{{ $fileUrl }}" target="_blank"
                                                                ...
                                                                @else
                                                                    <div
                                                                        class="flex h-full w-full items-center justify-center bg-gray-50 dark:bg-gray-700">
                                                            ...
                                                            {{-- filename bar --}}
                                                            <div
                                                                class="absolute inset-x-0 bottom-0 bg-black/40 px-2 py-1">
                                                                <div class="truncate text-sm text-white"
                                                                    title="{{ $at->name }}">{{ $at->name }}
                                                                </div>
                                                            </div>

                                                            {{-- delete existing --}}
                                                            <button type="button"
                                                                class="removeAttachmentExisting absolute right-2 top-2 rounded-full bg-white/90 p-1 shadow hover:bg-white"
                                                                data-id="{{ $at->id }}">
                                                                ✕
                                                            </button>
                                                        </div>
