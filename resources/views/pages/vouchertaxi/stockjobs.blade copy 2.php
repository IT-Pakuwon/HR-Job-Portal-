...
$(document).ready(function () {
        ...
        columns: [
            ...
            { data:'created_by' },
            {
                ...
                render: v => v
                    ...
                    : '<span class="text-blue-600 font-semibold">JOB</span>'
            }
        ]
    });
    ...
    pickInvTable = $('#pickInventoryTable').DataTable({
        processing:true,
        serverSide:true,
        ajax:"{{ route('stockjobs.inventory-pick.json') }}",
        columns:[
            {data:'inventoryid'},
            {data:'inventory_descr'}
        ]
    ...
    $('.status-filter').on('click', function(e){
        ...
        $jobsTitle.text(titleMap[f] || 'Stock Jobs');
    ...
    $('#filter_cpny, #filter_bu').on('change', function(){
                        ...
                        invTable = $('#inventoryTable').DataTable({
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(v){
                                        return v ? parseFloat(v).toLocaleString() : '0';
                                    }
                                },
                                {
                                    data: 'status',
        ...
        {{-- <script>
            $(document).ready(function() {
                ...
                $('.status-filter').on('click', function(e) {
                    e.preventDefault();
                    console.log('CARD CLICKED:', $(this).data('filter'));
