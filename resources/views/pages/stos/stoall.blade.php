                        ...
                        <form id="stoForm" class="flex flex-col" enctype="multipart/form-data">
                                ...
                                <div class="flex w-full items-end gap-4">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <select id="selectdeptname"
                                            class="min-w-[280px] rounded-sm border border-gray-200/50 bg-gray-200/10 p-3 focus:ring focus:ring-blue-300 dark:bg-gray-800"
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center justify-between gap-4 sm:flex-row"> 
                                    ...
                                    <button type="button" class="rounded-lg bg-indigo-500 px-5 py-2 text-white" onclick="chart.exportImg({full:true})">Export Image Full</button>
                                    {{-- <button type="button" class="rounded-lg bg-indigo-500 px-5 py-2 text-white" onclick="downloadPdf(chart)">Export PDF</button> --}}
                                </div>
