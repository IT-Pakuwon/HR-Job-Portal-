            ...
            <div class="mx-auto w-full px-2 py-1 sm:px-6 lg:px-2">
                <div class="gap-1">
                    <div
                                ...
                                <header
                                    ...
                                    <div class="flex items-center justify-between px-4">
                                        <button onclick="window.open('{{ route('orgchart.fullscreen') }}', '_blank')"
                                            class="rounded-md bg-blue-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-blue-700">
                                            🔍 Open Full
                                        </button>
                                    </div>
                                    ...
                                    <div id="modalForm"
                                        ...
                                        <div class="relative w-full max-w-xl rounded-lg bg-white p-4">
                                            ...
                                            <div id="tab-view" class="tab-content hidden">
                                                ...
                                                <table
                                                    class="w-full border   bg-gray-300/10 text-xs text-black">
                                                    <thead>
                                                        <tr class="text-left">
                        ...
                        <div>
                            <div class="w-1/2.5 flex flex-col gap-2">
                                <div class="flex max-h-96 min-h-[12rem] flex-col rounded-xl dark:bg-gray-800">
                                    <header
                                        class="flex items-center justify-between rounded-t-2xl bg-gray-50 px-6 py-4 dark:bg-gray-700">
                                    ...
                                    <div class="flex-grow overflow-y-auto rounded-b-2xl bg-white p-4 px-4">
                                        ...
                                        @php
                                            ...
                                            foreach ($employee as $emp) {
                                                $level = $level = $emp->department->subgrade_name ?? 'Unknown';
