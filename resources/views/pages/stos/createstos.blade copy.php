                ...
                <div class="relative w-full max-w-5xl rounded-lg bg-white p-4">
                    ...
                    <div id="tab-specprofile" class="tab-content hidden">
                        ...
                        <form id="formAddSpec" method="POST" action="{{ route('orgchart.store') }}">
                            ...
                            <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Experience in
                                        Position</label>
                    ...
                    <div id="modalChangeParent"
                        ...
                        <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
                            ...
                            <label class="mb-2 block text-sm font-medium text-gray-700">Select New Parent
                                Department</label>
                        ...
                        <div class="max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-lg bg-white p-6 shadow-xl">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                <button onclick="$('#modalJobProfile').addClass('hidden')"
                                    class="text-xl text-gray-600 hover:text-red-600">&times;</button>
                            </div>
                            ...
                            <div class="mb-4">
                                <table class="w-full border border-gray-200 text-sm">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="border border-gray-200 px-2 py-1">No</th>
                                            <th class="border border-gray-200 px-2 py-1">Job Purpose</th>
                                            <th class="border border-gray-200 px-2 py-1">Action</th>
                                        </tr>
                                    </thead>
                            ...
                            <div id="jobSpecInfo" class="space-y-2 text-sm text-gray-700">
