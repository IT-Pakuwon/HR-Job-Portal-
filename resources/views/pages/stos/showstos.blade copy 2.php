                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                                            @foreach ($employee as $p)
                                                                <div
                                                                    class="flex w-auto flex-wrap items-center justify-center space-x-2 whitespace-normal rounded-xl border border-gray-200 bg-white px-5 py-3 text-xs font-semibold text-gray-700 shadow-sm transition hover:  dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
                                                                    <span>{{ $p['employee_name'] }}:</span>
                                                                    <span
                                                                        class="text-indigo-600 dark:text-indigo-400">{{ $p['employee_company'] }}</span>
                                                                    <span
                                                                        class="text-indigo-600 dark:text-indigo-400">{{ $p['employee_position'] }}</span>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="modalForm"
                                        ...
                                        <div class="relative w-full max-w-xl rounded-lg bg-white p-6">
                                            ...
                                            <div id="tab-view" class="tab-content hidden max-w-5xl">
                                                ...
                                                <table
                                                    class="w-full border   bg-blue-300/10 text-xs text-black">
                                                    <thead>
                                                        <tr class="text-left">
                            ...
                            response.forEach((emp, index) => {
                                html += `
                                    <tr>
                                        ...
                                        <td class="border   px-2 py-1">${emp.employee_position}</td>
