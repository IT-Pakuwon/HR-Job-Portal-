<x-app-layout>
                        ...
                        <form id="formAddSpec" method="POST" action="{{ route('orgchart.store') }}">
                           ...
                           <div class="mb-4">
                            ...
                            <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-gray-700">Experience in Position</label>
    ...
    <script>
        ...
        d3.json("{{ route('orgchart.json') }}").then((res) => {
            ...
            // ⬇️ Tambahkan koneksi garis tambahan
            chart.connections(connections).render();
            // // 🎯 Ubah tampilan garis connections setelah render
            // chart.connectionUpdate(function (connectionSelection) {
            //     connectionSelection
            //         .filter(d => d.data.label === 'Additional Link')
            //         .attr('stroke', 'red')
