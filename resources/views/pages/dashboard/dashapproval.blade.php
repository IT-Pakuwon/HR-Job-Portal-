                    ...
                    let table = $('#agendasxTable').DataTable({
                        ...
                        columns: [{
                                ...
                                render: function(data, type, row) {
                                    ...
                                    let buttonClass =
                                        'inline-flex justify-center items-center w-[120px] px-3 py-1.5 text-xs leading-tight font-medium text-white rounded text-center transition-colors duration-200 bg-gray-500 hover:bg-gray-700';
