            ...
            <div class="mt-6  overflow-y-auto bg-white  dark:bg-gray-800 p-4 rounded-xl">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <h1 class=" align-middle text-2xl font-bold  dark:text-white">Manpower Planning</h1>                    
                            <a href="{{ url('/createmanpowers') }}" class="px-5 py-2 bg-indigo-500 text-white rounded-lg">
                                <i class="fas fa-plus pr-2"></i>Create Manpower</a>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg">
                    <table id="manpowersTable" class="min-w-full rounded mt-5">
                ...
                $(document).ready(function () {
                    let table = $('#manpowersTable').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'periodyear',className: 'no-pointer' },
                            { data: 'required',className: 'no-pointer'  },
                            { data: 'actual',className: 'no-pointer'  },
                            { data: 'total_actual',className: 'no-pointer'  },
                            {
