        ...
        <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="bg-white p-6 rounded-lg w-full max-w-xl relative">
                        ...
                        <div class="mb-4 border-b border-gray-200">
                            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="tabs">
                                ...
                                <li class="mr-2">
                                    <button type="button" class="tab-button text-gray-600 hover:text-blue-600 hover:border-blue-600 px-4 py-2" onclick="switchTab('employee')">Add Employee</button>
                                </li>
                                <li class="mr-2">
                                    <button type="button" class="tab-button text-gray-600 hover:text-blue-600 hover:border-blue-600 px-4 py-2" onclick="switchTab('departement')">Add Departement</button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="tab-view" class="tab-content hidden">
                            ...
                            <table class="w-full border border-black text-sm bg-blue-300 text-black">
                                <thead>
                                    <tr class="text-left">
                        ...
                        <div id="tab-employee" class="tab-content">
                            ...
                            <form id="formAddEmployee" method="POST" action="{{ route('orgchart.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="w-full p-3 border border-gray-200/50 rounded-sm focus:ring focus:ring-blue-300 bg-gray-200/10 dark:bg-gray-800"   name="cpnyid" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="w-full p-3 border border-gray-200/50 rounded-sm focus:ring focus:ring-blue-300 bg-gray-200/10 dark:bg-gray-800"   name="job_position" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="qty" class="mt-1 block w-full border border-gray-300 rounded-md p-2" value="1" required>
                                </div>
                                {{-- <div class="mb-4">
                        ...
                        <div id="tab-departement" class="tab-content hidden">
                            <h3 class="text-lg font-semibold mb-4">Add Departement</h3>
            ...
            <div class="col-span-12 lg:col-span-3">                
                <div class="bg-white p-4 rounded shadow">
                    <h3 class="text-lg font-semibold mb-4">Header Info</h3>
                    <form id="headerForm" method="POST" action="#">
                        @csrf
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">STO ID</label>
                            <input type="text" name="sto_id" class="mt-1 block w-full border border-gray-300 rounded-md p-2 bg-gray-100" placeholder="STO ID" readonly>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Date</label>
                            <input type="date" name="sto_date" class="mt-1 block w-full border border-gray-300 rounded-md p-2"
                                value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Created</label>
                            <input type="text" name="user" class="mt-1 block w-full border border-gray-300 rounded-md p-2 bg-gray-100" placeholder="Created" readonly>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700">Status</label>
                            <input type="text" name="status" class="mt-1 block w-full border border-gray-300 rounded-md p-2 bg-gray-100" placeholder="Status" readonly>
                        </div>
                        <div class="mt-6 flex justify-between gap-2">
                            <button type="submit" name="action" value="draft"
                                class="w-1/2 bg-gray-600 hover:bg-gray-700 text-white py-2 rounded">
                                Simpan Draft
                            </button>
                            <button type="submit" name="action" value="submit"
                                class="w-1/2 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded">
                                Submit
                            </button>
                        </div>
                    </form>
