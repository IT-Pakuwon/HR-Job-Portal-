    ...
    <div class="max-w-9xl mx-auto w-full px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="grid">
            <style>
                ...
                #poTable tbody tr:hover { background-color: #8f8f8f11; cursor: pointer; }
                #poTable th:nth-child(1), #poTable td:nth-child(1) { width: 160px; text-align: left; }
                #poTable th:nth-child(2), #poTable td:nth-child(2),
                #poTable th:nth-child(4), #poTable td:nth-child(4) { text-align: center; }
                #poTable th:nth-child(5), #poTable td:nth-child(5),
                #poTable th:nth-child(6), #poTable td:nth-child(6),
                #poTable th:nth-child(7), #poTable td:nth-child(7) { text-align: right; }
            </style>
                ...
                <div class="overflow-x-auto p-6">
                    <table id="poTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left  text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">PO Nbr</th>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Delivery Date</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Total</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Tax</th>
                                <th class="px-6 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Grand Total</th>
                ...
                $(document).ready(function () {
                    ...
                    function highlightActive(sc){
                        $('.scope-filter').removeClass('ring-2 ring-offset-2 ring-indigo-500')
                          .each(function(){ if($(this).data('scope')===sc){ $(this).addClass('ring-2 ring-offset-2 ring-indigo-500'); }});
                    }
                    updateTitle(scope); highlightActive(scope);
                    ...
                    const table = $('#poTable').DataTable({
                        ...
                        order: [[1, 'desc'], [0, 'desc']], // podate desc, lalu ponbr
                        ajax: {
