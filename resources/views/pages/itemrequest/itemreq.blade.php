    ...
    <div class="max-w-9xl mx-auto w-full px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div class="grid auto-rows-fr grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
            ...
            <button type="button" class="text-left">
                <a href="#" class="status-filter group block h-full active" data-status="">
        ...
        <div class="grid mt-6">
            <style>
                ...
                #itemReqTable th, #itemReqTable td {
                    padding: 10px;
                    max-width: 280px;
                }
                ...
                <div class="overflow-x-auto p-6">
                    <table id="itemReqTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="w-32 px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">IRID</th>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">PIC</th>
                        ...
                        columns: [
                            // IRID link + optional tracking button (kalau sudah ada endpoint)
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    let cls = 'inline-flex justify-center items-center w-[140px] px-3 py-1.5 text-base leading-tight font-semibold text-white rounded text-center transition-colors duration-200 bg-gray-500 hover:bg-gray-700';
                                    ...
                                    if (row.status === 'D' && row.created_by === currentUser) {
                                        ...
                                        cls = 'inline-flex justify-center items-center w-[140px] px-3 py-1.5 text-base leading-tight font-semibold text-white rounded text-center transition-colors duration-200 bg-yellow-500 hover:bg-yellow-700';
                                    }
                            ...
                            { data: 'irdate', className: 'text-left' },
                            { data: 'cpny_id', className: 'text-center w-32' },
                            { data: 'department_id', className: 'text-center whitespace-normal break-words' },
                            { data: 'inventory_descr_req', defaultContent: '-', className: 'text-left' },
                            { data: 'pic_item_req', defaultContent: '-', className: 'text-left' },

                            {
                                ...
                                render: function (data) {
                                    const map = {
                                        'D': { t: 'Revise / Draft', c: 'bg-gray-300/30 text-gray-600' },
