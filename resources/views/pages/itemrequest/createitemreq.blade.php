<x-app-layout>
                ...
                <form id="sppbForm" class="flex flex-col gap-4" enctype="multipart/form-data">
                    ...
                    <div class="w-full rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                        ...
                        <div class="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
                            <h2 class="text-xl font-extrabold text-gray-800 dark:text-white">Create Item Req</h2>
                        </div>
        ...
        $(function() {
            ...
            function validateDetails() {
                ...
                if ($first.length) {
                    ...
                    $first.trigger('focus');
                    toastr.error('Mohon perbaiki field yang ditandai merah pada detail ItemReq.');
                    return false;
                }
                return true;
            }
    ...
    <script>
        ...
        $('#departementid').on('change', function() {
            ...
            if (hasInventory) {
                alert("Department tidak bisa diubah karena sudah ada inventory di ItemReq Detail.");
