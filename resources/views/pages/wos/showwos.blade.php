                    ...
                    <div class="flex flex-1 flex-col overflow-y-auto p-4">
                        <div class="grid grid-cols-1 gap-x-8 gap-y-3 text-sm sm:grid-cols-2">
                            ...
                            <div class="flex items-center gap-2 p-2">
                                ...
                                <span
                                    class="break-words font-medium text-gray-900 dark:text-gray-300">{{ $wo->cpny_id }}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 p-2">
                                ...
                                <span
                                    class="break-words font-medium text-gray-900 dark:text-gray-300">{{ $wo->department_id }}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 p-2">
                                ...
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ date('j F Y', strtotime($wo->wodate)) }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 p-2">
                                ...
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ ucwords(strtolower(optional($wo->creator)->name)) }}
                                </span>
                            </div>
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Wo Type</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ $wo->wotype }}
                                </span>
                            </div>
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Wo Request</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ $wo->worequest }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Jenis Pekerjaan</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ optional($wo->worktype)->worktype_name ?? $wo->worktypeid }}
                                </span>
                            </div>
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Sub Jenis Pekerjaan</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ optional($wo->subworktype)->subworktype_name ?? $wo->subworktypeid }}
                                </span>
                            </div>
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Pic Request</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ $wo->picrequester }}
                                </span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Location</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                                    {{ optional($wo->location)->location_name ?? $wo->location_id }}
                                </span>
                            </div>
                            <div class="flex items-center gap-2 p-2">
                                <x-heroicon-o-user class="h-5 w-5 text-gray-400" />
                                <span class="min-w-32 max-w-32 text-gray-500">Sub Location</span>
                                <span class="break-words font-medium text-gray-900 dark:text-gray-300">
                            ...
                            <div class="col-span-1 flex flex-col gap-3 sm:flex-row">
                                ...
                                <div class="flex flex-2 items-center gap-2 rounded-md bg-gray-50 p-3 dark:bg-gray-700">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span <span
                                            class="break-words font-medium text-gray-900 dark:text-gray-300">{{ $wo->keperluan }}</span>
                                    </div>
                                </div>
