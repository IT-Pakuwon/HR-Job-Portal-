        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:grid-rows-[minmax(0,auto)_1fr]">
            <div class="flex flex-col gap-8 lg:col-span-2 lg:row-span-1">
                ...
                <form id="woForm" class="flex flex-col gap-4" enctype="multipart/form-data"
                    ...
                    <div class="w-full rounded-2xl bg-white p-6 shadow dark:bg-gray-800">

                        <!-- Header -->
                        <div class="mb-6 flex items-center justify-between border-b pb-3 dark:border-gray-700">
                            <h2 class="text-xl font-bold text-gray-800 dark:text-white">✏️ Edit WO —
                                {{ $prefill['woid'] }}</h2>
                        </div>
                                ...
                                <select name="cpnyid" required
                                    ...
                                    @foreach ($usercpny as $p)
                                        <option value="{{ $p->cpnyid }}"
                                            {{ $p->cpnyid == $prefill['cpnyid'] ? 'selected' : '' }}>
                                            {{ $p->cpnyid }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="departementid" required
                                    ...
                                    @foreach ($userdept as $p)
                                        <option value="{{ $p->deptname }}"
                                            {{ $p->deptname == $prefill['departementid'] ? 'selected' : '' }}>
                                            {{ $p->deptname }}
                                        </option>
                                    @endforeach
                                </select>
