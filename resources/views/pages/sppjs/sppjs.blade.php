<x-app-layout>
    ...
    <div class="max-w-9xl mx-auto w-full p-2">
        ...
        <div
            ...
            {{-- SPPJ All List  --}}
            @if (auth()->user()->hasRole('COSTCTRLACCESS') || auth()->user()->hasRole('FAACCESS') || auth()->user()->hasRole('FINACCESS'))
                <button type="button" class="text-left">
        ...
        <div
            ...
            <div class="relative overflow-hidden">
                <table id="sppjsTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
                            ...
                            <th scope="col" class="w-24 px-4 py-3 text-left font-medium">
                                Bq Type
                            </th>
                            <th scope="col" class="w-32 px-4 py-3 text-left font-medium">
                                Request Type
                ...
                columns: [{
                    ...
                    // DocID (button link)
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            // jika status Draft/Revise & milik current user → ke halaman edit
