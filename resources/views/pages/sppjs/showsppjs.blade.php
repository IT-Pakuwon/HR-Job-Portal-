<x-app-layout>
        ...
        <div class="w-full max-w-md rounded-lg bg-white p-4 dark:bg-gray-700">
            ...
            <div class="mt-4 flex justify-between">
                ...
                <button id="confirmReviseBtn"
                    class="inline-flex items-center gap-1 rounded-md bg-gray-500 px-3 py-2 text-sm font-medium text-gray-100 transition-colors hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-700/30 dark:text-gray-300 dark:hover:bg-gray-600/50 dark:text-gray-200">
                    Revise
                </button>
    ...
    @include('partials.private-note-widget', ['doctype' => 'PJ', 'refnbr' => $sppj->sppjid])
    ...
    <script>
        $(document).ready(function() {
            ...
            attachMentionAutocomplete({
                ...
                fetchUrlFn: () => `/mentionable-users/${doctype}/${sppjid}`,
            });
