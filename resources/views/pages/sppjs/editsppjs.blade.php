                ...
                <form id="sppjForm" class="flex flex-col gap-4" enctype="multipart/form-data"
                    ...
                    <div class="w-full rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
                        ...
                        <div class="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
                            <h2 class="text-xl font-extrabold text-gray-800 dark:text-white"> Edit SPPJ —
                                {{ $sppj->sppjid }}</h2>
                        </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex w-full">
                                    @php
                                        ...
                                        $selectedRTName = old('requesttype_name', $sppj->requesttype_name ?? optional($sppj->requestType)->requesttype_name ?? '');
                                    @endphp
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="bqtype" id="bqtype" required
                                    ...
                                    <option value="Jasa" {{ old('bqtype', $sppj->bqtype) == 'Jasa' ? 'selected' : '' }}>
                                        Jasa
                                    </option>
                                    <option value="Kontrak" {{ old('bqtype', $sppj->bqtype) == 'Kontrak' ? 'selected' : '' }}>
                                        Kontrak
                                    </option>
                                </select>
                            </div>
