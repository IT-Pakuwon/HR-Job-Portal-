    ...
    <div class="max-w-9xl mx-auto w-full p-2">
        <div
            ...
            <div
                ...
                <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">🚗 Kendaraan
                    List</h2>
            ...
            <div class="relative overflow-hidden">
                <table id="kendaraanTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3 text-left font-medium">Nama Kendaraan</th>
                            <th class="px-4 py-3 text-left font-medium">Kategori Kendaraan</th>
                            <th class="px-4 py-3 text-left font-medium">Type Kendaraan</th>
                            <th class="px-4 py-3 text-left font-medium">Merk Kendaraan</th>
                            <th class="px-4 py-3 text-left font-medium">Pemilik Kendaraan</th>
