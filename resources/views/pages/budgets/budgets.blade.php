        ...
        <div class="grid">
            ...
            <div class="mt-2 overflow-y-auto rounded-xl bg-white p-4 dark:bg-gray-800">
                <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                    <h1 class="align-middle text-2xl font-bold dark:text-white">Budget</h1>                    
                        <a href="{{ url('/createbudgets') }}" class="rounded-lg bg-indigo-500 px-5 py-2 text-white">
                        <i class="fas fa-plus pr-2"></i>Import Budget</a>
                </div>
                <div class="rounded-lg bg-white dark:bg-gray-800">
                    <table id="budgetsTable" class="mt-5 min-w-full rounded">
                        <thead class="bg-white-200 dark:text-white">
                            <tr>
                                <th class="w-32 px-4 py-3 text-left">DocID</th>
                                <th class="px-4 py-3 text-center">Date</th>
                                <th class="px-4 py-3 text-center">Perpost</th>
                                <th class="px-4 py-3 text-center">Company</th>
                                <th class="px-4 py-3 text-center">Business Unit</th>
                                <th class="px-4 py-3 text-center">Departement</th>
                                <th class="px-4 py-3 text-center">Total Budget</th>                                
