        ...
        <div class="flex w-full flex-col gap-6 overflow-hidden sm:col-span-1 lg:row-span-1 xl:row-span-1 xl:flex-col">
            ...
            <div class="min-h-[12rem] flex-col rounded-xl dark:bg-gray-800">
                ...
                <div class="relative overflow-x-auto">
                    <table id="budget-table" class="display nowrap w-full bg-white text-xs dark:bg-gray-800">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="w-[120px] px-4 py-2">Account</th>
                                <th class="w-[140px] px-4 py-2">Activity ID</th>
                                <th class="w-[260px] px-4 py-2">Description</th>
                                <th class="w-[260px] px-4 py-2">Detail</th>
                                <th class="w-[100px] px-4 py-2">Qty</th>
                                <th class="w-[160px] px-4 py-2">Unit Price</th>
                        ...
                        <tbody>
                            @foreach ($budgetdetail as $item)
                                <tr
                                    class="bg-white hover:bg-gray-50 dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
