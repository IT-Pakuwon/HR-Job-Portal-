                ...
                <div class="border-t border-gray-200 bg-gray-50 px-4 py-4 dark:border-gray-700 dark:bg-gray-900">
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                        ...
                        <div class="rounded-lg bg-white p-3 shadow-sm dark:bg-gray-800">
                            ...
                            <div id="mTotBudg" class="mt-1 text-xs font-extrabold text-gray-900 dark:text-white">
                                Rp. 0
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg bg-white p-3 shadow-sm dark:bg-gray-800">
                            ...
                            <div id="mTotAddi" class="mt-1 text-xs font-extrabold text-blue-600">
                                Rp. 0
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg bg-white p-3 shadow-sm dark:bg-gray-800">
                            ...
                            <div id="mTotRese" class="mt-1 text-xs font-extrabold text-amber-600">
                                Rp. 0
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg bg-white p-3 shadow-sm dark:bg-gray-800">
                            ...
                            <div id="mTotUsed" class="mt-1 text-xs font-extrabold text-red-600">
                                Rp. 0
                            </div>
                        </div>
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-4 py-4 dark:border-gray-700 dark:bg-gray-900">
                    <div class="flex justify-end">
                        <div class="rounded-lg bg-white px-4 py-3 shadow-sm dark:bg-gray-800">
                            ...
                            <div id="tTotAmount" class="mt-1 text-xs font-extrabold text-indigo-600">
                                Rp. 0
                            </div>
                        </div>
                    </div>
