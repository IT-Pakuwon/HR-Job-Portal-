<x-app-layout>
    @php
        $currentPage = Route::currentRouteName() == 'news' ? 'HR' : '';
    @endphp
        ...
        <div class="grid">
            ...
            <div class="mt-2 overflow-y-auto rounded-xl bg-white p-4 dark:bg-gray-800">
                <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                    <h1 class="align-middle text-2xl font-bold dark:text-white">News</h1>
                    <a href="{{ url('/createnews') }}" class="rounded-lg bg-indigo-500 px-5 py-2 text-white">
                        <i class="fas fa-plus pr-2"></i>Create News</a>
                </div>
                <div class="rounded-lg bg-white dark:bg-gray-800">
                    <table id="newsTable" class="mt-5 min-w-full rounded">
