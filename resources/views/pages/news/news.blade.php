        ...
        <div class="grid">
            ...
            <div
                ...
                <div class="flex flex-col gap-4 border-b border-gray-100 px-5 py-2 dark:border-white/[0.06] sm:flex-row sm:items-center sm:justify-between">
                    <h2 class="text-base font-semibold tracking-tight text-gray-800 dark:text-gray-100">News</h2>
                ...
                <div class="relative overflow-hidden">
                    <table id="newsTable" class="w-full min-w-full border-separate border-spacing-0 text-sm">
                        <thead>
                            <tr
