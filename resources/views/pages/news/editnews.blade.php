                        ...
                        <form id="newsForm" class="flex flex-col gap-4" enctype="multipart/form-data">
                            ...
                            <div
                                ...
                                <div class="flex justify-between border-b dark:border-gray-600">
                                    <h2 class="mb-2 text-base font-bold">Edit News</h2>
                                    <h2 class="mb-4 text-base font-bold">{{ $news->docid }}</h2>
                                </div>
                                <div
                                    ...
                                    <details class="group mb-4" open>
                                        ...
                                        <div class="flex h-auto flex-col justify-start">
                                            ...
                                            <button type="button" id="addAttachment"
                                                class="mb-4 mt-4 flex items-center justify-center gap-2 rounded border border-gray-700 bg-gray-200/10 p-2 text-gray-800 hover:border-indigo-700 hover:bg-indigo-200/10 hover:font-medium hover:text-indigo-800 dark:text-gray-200">
