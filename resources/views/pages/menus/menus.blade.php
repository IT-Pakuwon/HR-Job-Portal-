        ...
        <div class="grid">
            ...
            <style>
                .menu-tree ul {
                    ...
                    border-left: 1px solid rgba(156, 163, 175, 0.6); /* gray-400 */
                }
                .menu-tree li {
                    margin: 2px 0;
                }
            ...
            <div class="mt-6 rounded-xl bg-white p-4 dark:bg-gray-800">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">📋 Sys Menu Tree</h2>
                ...
                <div id="menuTreeContainer" class="mt-2">
                    ...
                    <div class="text-gray-500 text-sm">Loading menus...</div>
                </div>
            </div>
