...
<body>
        ...
        <tr>
            <td class="left-info">
                <table class="info-left-table">
                    <tr>
                        <td class="info-label">Kepada/To</td>
                        <td class="info-colon">:</td>
                        <td class="info-value">TREASURY</td>
                    </tr>
            ...
            <td class="right-info">
                <table class="info-right-table">
                    <tr>
                        ...
                        <td class="right-value nowrap">{{ $rfcadate ?: '-' }}</td>
                    </tr>

                    <tr>
                        <td class="right-label">Payment Ready</td>
                        <td class="right-colon">:</td>
                        <td class="right-value nowrap">{{ $created_at_fmt ?: '-' }}</td>
                    </tr>

                    <tr>
                        <td class="right-label">Tgl CALR</td>
                        <td class="right-colon">:</td>
                        <td class="right-value nowrap">{{ $calr_date ?: '-' }}</td>
                    </tr>

                    <tr>
                        <td class="right-label">Tgl Diperlukan</td>
                        <td class="right-colon">:</td>
                        <td class="right-value nowrap">{{ $required_date ?: '-' }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table class="amount-summary">
        <tr>
            <td style="width: 25%;">Jumlah/Amount</td>
            <td style="width: 2%;">:</td>
            <td colspan="4">Rp. {{ number_format($amountRfca, 0, ',', '.') }}</td>
        </tr>
