        ...
        <tr>
            <td align="center" valign="top">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
                    ...
                    {{-- Header --}}
                    <tr>
                        <td style="background-color:#4338ca;background:linear-gradient(135deg,#312e81 0%,#4338ca 55%,#6366f1 100%);border-radius:16px 16px 0 0;padding:32px 40px 28px;">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td>
                                        <p style="margin:0 0 16px;display:inline-block;background:rgba(255,255,255,0.15);border-radius:999px;padding:3px 12px;font-size:10px;font-weight:700;color:#c7d2fe;letter-spacing:0.12em;text-transform:uppercase;">
                                ...
                                <tr>
                                    <td>
                                        <p style="margin:0;font-size:11px;color:#94a3b8;line-height:1.7;">
                                            This is an automated email from <strong style="color:#64748b;">Talent Acquisition, {{ $company ?? 'Pakuwon Group Jakarta' }}</strong>.<br>
