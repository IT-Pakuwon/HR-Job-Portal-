...
<head>
    <meta charset="UTF-8">
    <title>Sertifikat Training Tersedia</title>
</head>
        ...
        ">
                    <tr>
                        <td style="background:#1e1b4b; padding:20px; text-align:center; color:#ffffff;">
                            <h2 style="margin:0; font-size:22px;">{{ $docid }} — Sertifikat Tersedia</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:14px; line-height:1.6;">
                            ...
                            <p>Sertifikat Anda untuk training <strong>{{ $training_name }}</strong> sudah tersedia dan dapat diunduh kapan saja.</p>
