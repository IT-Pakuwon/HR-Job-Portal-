<x-authentication-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="space-y-4">
            ...
            <div>
                <x-label class="text-sm text-gray-700 dark:text-white" for="login" value="{{ __('Email') }}" />
                <x-input class="w-90 py-3 px-4 text-sm mb-2" id="login" type="text" name="login" :value="old('login')" required autofocus />
            </div>
